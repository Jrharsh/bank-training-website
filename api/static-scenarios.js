const SCENARIO_OPS_ERROR_FRAUD = {
  ...
  questions: [
    ...
    q("Deposits", "How should Deposits manage call center overload during the incident?", buildChoices(
      ...
      "Add scripts for staff but keep the phone tree the same, offering some support but maintaining the existing call routing. Share periodic updates and ensure all actions are reviewed for load and messaging consistency after restoration.", "Helpful, but still high volume without automation.", 5,
      ...
      "Tell customers everything is fine without providing facts, offering vague reassurances that may damage credibility and increase confusion. Only update after full correction and ensure all actions are reviewed for load and messaging consistency after restoration.", "Credibility risk and confusion.", -5
    )),
  ]
};
const SCENARIO_DATA_UNVERIFIABLE = {
  ...
  questions: [
    ...
    q("Accounting", "How should Accounting address audit trail sufficiency with incomplete logs?", buildChoices(
      ...
      "Rely on verbal explanations instead of written records, providing only staff recollections. Only update after full evidence is recovered and ensure all actions are reviewed for completeness and defensibility after restoration.", "Weakens audit trail and defensibility.", -5
    )),
  ]
};
...
const SCENARIO_INSIDER_FRAUD = {
  ...
  questions: [
    ...
    q("CEO/SVPs", "Upon learning that insider fraud has been flagged by internal audit, what is the first comprehensive action leadership should take to ensure the organization responds effectively and lawfully?", buildChoices(
      "Immediately convene the incident response team, including Legal, HR, IT, and Audit, to establish a coordinated governance structure. Set a preservation-first posture, assign clear roles for evidence protection, and ensure all actions are documented in real time. Communicate the plan to executive stakeholders, initiate a timeline for key decisions, and prepare for regulatory and law enforcement engagement as needed.", "Ensures coordinated, defensible actions and preserves evidence while preparing for all downstream requirements.", 10,
      "Allow the audit department to continue its review in isolation, instructing other departments to avoid involvement until a final report is issued. Monitor for new developments, but avoid any immediate disruption to business operations or staff routines. Prepare to escalate only if the situation appears to worsen or if additional risks are identified.", "Too slow; evidence and losses can grow, and lack of coordination may compromise the response.", 5,
      "Suspend all customer-facing communications and marketing activities until the end of the month, pausing outreach and updates to avoid premature disclosure. Document the rationale for the blackout, monitor for customer impacts, and plan to resume communications with a comprehensive report after the investigation concludes.", "Delays can harm customers and trust, and may create confusion or suspicion.", -5,
      "Require the implicated employee to make a public statement to all staff before any formal action is taken, recording the process for transparency. Communicate the risks to Legal and HR, and review for evidence contamination or prejudicial effects after the fact.", "Prejudicial and risky; can taint evidence and create legal exposure.", -5
    )),
    q("CEO/SVPs", "On the first day of the incident, what is the most appropriate and defensible approach to disclosing the situation both internally and externally?", buildChoices(
      "Limit disclosure strictly to those with a need-to-know, using carefully prepared scripts for internal communication. For external parties, provide information only if customers are directly impacted, and ensure all messaging is reviewed by Legal and Communications. Track every communication, update scripts as the investigation progresses, and document the rationale for all disclosure decisions.", "Balances transparency, privacy, and the integrity of the investigation while reducing legal risk.", 10,
      "Issue a public press release naming the employee and describing the incident in detail to media, customers, and stakeholders. Document the rationale for full transparency, monitor for legal and privacy risks, and prepare to address any fallout or questions that arise from the disclosure.", "Legal/privacy risk; may expose the organization to liability and reputational harm.", 5,
      "Instruct all branch staff to improvise answers if asked by customers or the public, allowing each location to respond as they see fit. Track all responses, review for inconsistencies, and plan to standardize communications after the initial phase if needed.", "Inconsistent and risky; increases the chance of misinformation and legal exposure.", -5,
      "Distribute raw audit workpapers and findings widely to all staff and stakeholders, providing full transparency from the outset. Record what is shared, communicate risks to management, and review for uncontrolled information flow after the investigation.", "Uncontrolled and risky; may compromise the investigation and privacy obligations.", -5
    )),
    q("CEO/SVPs", "What is the most effective and legally sound way for leadership to engage with law enforcement when insider fraud is suspected?", buildChoices(
      "Consult with legal counsel to determine the appropriate timing and method for law enforcement engagement. Preserve the chain of custody for all evidence, coordinate with law enforcement only if legal thresholds are met, and document every interaction. Communicate the engagement plan to executive stakeholders and ensure investigative integrity is maintained throughout the process.", "Defensible coordination that protects the investigation and meets legal obligations.", 10,
      "Contact local police immediately with preliminary information, providing initial details before a full internal review is conducted. Track all communications, monitor for evidence handling issues, and prepare to follow up with complete documentation as needed.", "May compromise evidence handling and the integrity of the investigation.", 5,
      "Decide to handle the matter entirely internally, avoiding any law enforcement involvement regardless of the scale of the fraud. Document the rationale, monitor for missed recovery or deterrence opportunities, and review for governance risks after the investigation.", "Misses recovery/deterrence opportunities and may violate legal or regulatory requirements.", -5,
      "Allow the implicated employee to decide whether law enforcement should be involved, deferring to their preference for next steps. Record the process, communicate risks to management, and review for conflicts or governance failures after the fact.", "Conflict and governance failure; abdicates leadership responsibility and creates legal risk.", -5
    )),
    ...
    q("IT/Security", "When insider fraud is suspected, what is the most effective immediate action IT/Security should take regarding system access, and how should this be executed?", buildChoices(
      "Promptly disable all accounts, tokens, and privileged credentials associated with the implicated employee, including any shared or cross-departmental access. Conduct a rapid review of all privileged access logs, coordinate with HR and Legal to ensure no access is overlooked, and document every step. Notify IT and security teams of the changes, and implement enhanced monitoring for any attempted access or privilege escalation post-removal.", "Reduces further loss, closes exposure, and ensures a defensible access trail.", 10,
      "Increase monitoring of the employee’s accounts but leave access active to observe behavior, tracking all activity in real time. Record findings, communicate risks to management, and prepare to disable access if suspicious actions are detected during the monitoring period.", "Leaves risk window open and may allow further loss or evidence tampering.", 5,
      "Distribute admin credentials to all IT and security staff to expedite investigation and remediation, providing broad access to necessary systems. Track who receives credentials, monitor for segregation failures, and plan to reset all access once the incident is resolved.", "Segregation failure; increases risk of further compromise and audit issues.", -5,
      "Disable all system logging to reduce noise and improve performance during the incident, suspending record-keeping for the duration. Document the rationale, inform relevant teams, and plan to restore logging and review for evidence loss after the investigation.", "Destroys forensics and undermines the investigation.", -5
    )),
    q("IT/Security", "What are the best practices for preserving technical evidence in an insider fraud investigation, and how should this be communicated and maintained?", buildChoices(
      "Immediately snapshot all relevant systems, collect comprehensive logs (including access, transaction, and security logs), and store them in a secure, access-controlled repository with a documented chain-of-custody. Communicate preservation procedures to all technical staff, conduct regular reviews of evidence integrity, and ensure all actions support legal, regulatory, and recovery requirements throughout the process.", "Supports legal, regulatory, and recovery steps with strong forensics.", 10,
      "Instruct staff to save screenshots and key files to a shared drive, relying on manual capture of evidence. Track completeness, inform compliance of the approach, and review for weak or incomplete forensics after restoration.", "Partial but weak forensics; may miss critical evidence.", 5,
      "Delete older or unneeded logs to save storage space during the investigation, removing records that are not immediately relevant. Document the rationale, communicate risks to management, and review for evidence loss after the incident is resolved.", "Loss of evidence; may compromise the investigation and legal defense.", -5,
      "Allow staff to export data locally for convenience, permitting personal copies of key files and logs. Track all exports, inform compliance, and review for privacy or integrity risks after the investigation.", "Privacy/integrity risk; increases chance of data leakage or tampering.", -5
    )),
    q("IT/Security", "If the implicated employee had access to multiple departments and integrated systems, what controls should be implemented immediately to prevent further spread or lateral movement?", buildChoices(
      "Conduct an urgent, organization-wide access review across all integrated applications and systems, immediately rotate all shared secrets and privileged credentials, and validate the integrity of vendor integrations. Communicate all changes to internal and external stakeholders, document every action, and implement continuous monitoring for any signs of lateral movement or unauthorized access attempts after containment.", "Closes lateral paths quickly and reduces risk of further compromise.", 10,
      "Focus only on the primary application the employee used, reviewing access and activity in that system while deferring review of other systems. Track findings, communicate risks to management, and prepare to expand the review if new evidence emerges.", "Misses other access vectors and may allow undetected spread.", 5,
      "Rely solely on vendor logs and external monitoring to detect any further issues, assuming that third-party systems will alert to suspicious activity. Document the rationale, monitor for delays in containment, and review for missed access vectors after the investigation.", "Over-reliance; delays containment and may miss internal threats.", -5,
      "Turn off all monitoring tools to improve system performance during the incident, suspending visibility until the investigation is complete. Record the rationale, inform relevant teams, and plan to restore monitoring and review for missed activity after the fact.", "Removes visibility and increases risk of undetected activity.", -5
    )),
    ...
    q("HR", "When an employee is implicated in insider fraud, what is the most appropriate first HR action, and how should it be executed to protect both the investigation and the organization?", buildChoices(
      "Place the implicated employee on immediate administrative leave pending investigation, ensuring Legal and IT are present for all communications and asset collection. Secure all company property, access cards, and devices, and document every step with signed acknowledgments. Communicate the process to relevant staff, monitor for any attempts at interference or evidence loss, and coordinate with security for physical and digital access control.", "Reduces interference, preserves evidence, and protects the organization from further risk.", 10,
      "Terminate the employee’s employment immediately without full documentation or review, ending their access and relationship with the company on the spot. Track all actions, communicate risks to management, and prepare to address complications in investigation, recovery, and potential legal claims.", "May complicate investigation, recovery, and expose the organization to legal risk.", 5,
      "Announce the incident and the employee’s involvement to all staff as a warning, making an example of the situation to deter future misconduct. Record the process, communicate risks to HR and Legal, and review for culture and legal impacts after the fact.", "Culture and legal risk; may create a hostile environment and legal exposure.", -5,
      "Take no action until the audit team provides a final loss amount, delaying all HR involvement until a full report is available. Document the rationale, monitor for containment and safety risks, and review for missed opportunities after the investigation.", "Delays containment and safety, and may allow further harm.", -5
    )),
    q("HR", "What is the most effective guidance HR should provide to staff during an insider fraud investigation, and how should it be delivered?", buildChoices(
      "Instruct all staff to report any concerns or relevant information through the official whistleblower or incident reporting channel, emphasizing the importance of avoiding speculation and preserving evidence. Deliver the guidance in writing and in person, track compliance, and review for consistency and effectiveness after the incident. Reinforce confidentiality and the organization’s commitment to a fair process.", "Encourages reporting, consistency, and protects the investigation.", 10,
      "Encourage open discussion about the incident in group chats and informal meetings to surface potential leads, allowing staff to share information freely. Track all discussions, monitor for uncontrolled risks, and plan to standardize reporting after the investigation.", "Uncontrolled and risky; may spread rumors and compromise evidence.", 5,
      "Threaten disciplinary action for any mention of the case, warning staff against discussing the incident under any circumstances. Document the approach, monitor for reporting chills, and review for effectiveness and culture impacts after the fact.", "Chills reporting and may suppress important information.", -5,
      "Share the implicated employee’s name and details of the case with all staff for transparency, providing full information to the workforce. Track all communications, inform HR and Legal of risks, and review for privacy and legal impacts after the incident.", "Privacy and legal risk; may violate confidentiality and create legal exposure.", -5
    )),
    q("HR", "How should HR manage staff safety, morale, and operational coverage during an ongoing insider fraud investigation?", buildChoices(
      "Coordinate schedules and designate backup personnel for all critical roles, offering remote work or flexible arrangements as needed to reduce stress. Communicate all changes clearly to staff, provide access to support resources (such as counseling or EAP), and monitor for signs of burnout or morale issues. Track coverage and review for service impacts throughout the incident, adjusting as necessary to maintain both safety and business continuity.", "Reduces burnout, maintains service, and supports staff well-being.", 10,
      "Maintain all normal schedules and routines regardless of the incident, instructing staff to continue standard operations without adjustment. Track response times, monitor for slowdowns, and prepare to adjust schedules only if service quality declines significantly.", "May slow response and increase stress, risking service quality and morale.", 5,
      "Suspend all operations for the week, pausing all work until the incident is fully resolved. Document the rationale, monitor for customer harm, and review for overreaction after restoration.", "Overreaction and customer harm; disrupts business continuity.", -5,
      "Allow teams to self-organize coverage with no oversight or direction from HR, letting staff manage their own schedules and responsibilities. Track all decisions, monitor for inconsistencies, and review for risks after the incident.", "Inconsistent and risky; may lead to gaps in coverage and increased stress.", -5
    )),
    ...
    q("Finance", "What is the most effective way for Finance to track potential losses during an insider fraud investigation, and how should this process be managed?", buildChoices(
      "Establish a dedicated incident cost center and a detailed exposure ledger, requiring approvals for all entries. Track every potential loss as it arises, categorize exposures by type (e.g., direct loss, legal, remediation), and communicate the process to Finance, Audit, and Executive teams. Review records for accuracy and audit readiness throughout the investigation, and ensure all documentation is retained for regulatory review.", "Accurate, transparent, and audit-ready; supports recovery and regulatory needs.", 10,
      "Wait to estimate losses until law enforcement or external investigators are engaged, deferring tracking until official input is received. Document the rationale, monitor for late or inaccurate records, and review for missed exposures after the incident.", "Late and inaccurate; may miss timely recovery or reporting opportunities.", 5,
      "Record all losses in miscellaneous or general expense categories, spreading costs across unrelated accounts to avoid drawing attention. Track all entries, inform management of the approach, and review for transparency and audit risks after restoration.", "Lack of transparency; may create audit and regulatory issues.", -5,
      "Avoid tracking losses until customers or external parties complain, waiting for outside reports before recording any exposures. Document the rationale, monitor for reactive risks, and review for missed opportunities after the investigation.", "Reactive and risky; may result in missed recovery and reputational harm.", -5
    )),
    q("Finance", "During the investigation, what spending should Finance prioritize, and how should these priorities be communicated and controlled?", buildChoices(
      "Prioritize spending on forensics, enhanced monitoring, legal support, and recovery work directly aligned to the incident response. Require approvals for all expenditures, communicate priorities to Finance and management, and review spending for effectiveness and alignment with investigation goals. Adjust priorities as the investigation progresses, and document all decisions for transparency and audit purposes.", "Reduces future loss, speeds clarity, and ensures spending is defensible.", 10,
      "Freeze all spending to avoid criticism or scrutiny, suspending all payments and reimbursements during the investigation. Track impacts on investigation and recovery, document the rationale, and review for delays or missed opportunities after restoration.", "Slows investigation and recovery; may hinder response efforts.", 5,
      "Cut security and monitoring tooling to save money, reducing investment in protective measures during the incident. Track all changes, monitor for increased risk, and review for impacts on investigation and future prevention.", "Increases risk and may compromise the investigation.", -5,
      "Authorize payments for incident response without any approvals to expedite the process, bypassing normal controls. Track all expenditures, inform management of risks, and review for control failures after the investigation.", "Control failure; may result in fraud or waste.", -5
    )),
    q("Finance", "How should Finance approach customer restitution or credits if losses or harm are identified during the insider fraud investigation?", buildChoices(
      "Work with Legal to document clear, defensible criteria for customer remediation or credits, and track all cases centrally in a secure system. Communicate the process and criteria to all relevant staff, review for fairness and consistency, and update criteria as new information emerges. Ensure all remediation actions are documented and audit-ready throughout the investigation.", "Fair, consistent, and defensible; protects customers and the organization.", 10,
      "Allow each branch or department to handle refunds and credits at their own discretion, making ad-hoc decisions based on local judgment. Track all cases, monitor for inconsistencies, and review for risks after the incident is resolved.", "Inconsistent and risky; may create fairness and reputational issues.", 5,
      "Deny all customer claims until the final investigation report is complete, pausing all remediation or credits until the process ends. Document the rationale, monitor for trust and reputation risks, and review for missed opportunities after restoration.", "Trust and reputation risk; may harm customer relationships.", -5,
      "Issue universal refunds or credits to all potentially affected customers immediately, regardless of actual impact. Track all payments, monitor for abuse and misstatements, and review for sustainability after the incident.", "Encourages abuse and misstatements; may not be financially sustainable.", -5
    )),
    ...
    q("Loans", "If loan files were accessed during the insider fraud incident, what should the Loans department do to protect privacy, integrity, and auditability?", buildChoices(
      "Immediately restrict access to all affected loan files, validate the integrity of each file, and require dual review for any exceptions or changes. Communicate new procedures to all Loans staff, track every access and modification, and review for privacy and audit trail protection throughout the incident. Document all actions for regulatory and audit purposes.", "Protects privacy, integrity, and audit trail; supports regulatory compliance.", 10,
      "Continue normal loan processing and file access until specific issues or complaints arise, maintaining standard operations. Track all activity, monitor for new risks, and prepare to escalate only if problems are detected.", "Reactive and risky; may allow further harm or loss of evidence.", 5,
      "Allow staff to use personal email accounts for backup copies of loan documents, instructing them to transfer files as needed for convenience. Track all communications, inform compliance of the approach, and review for privacy or policy breaches after restoration.", "Privacy/policy breach; increases risk of data leakage and non-compliance.", -5,
      "Share system credentials among all involved staff to speed up verification and review, providing broad access to necessary systems. Record who receives credentials, monitor for segregation failures, and reset all access once normal operations resume.", "Segregation failure; undermines security and auditability.", -5
    )),
    q("Loans", "What is the most secure and effective way to verify changes to borrower payout instructions during an insider fraud investigation?", buildChoices(
      "Require all changes to borrower payout instructions to be verified using out-of-band methods with known contacts and documented evidence. Communicate the verification procedures to all staff, track every verification, and review for fraud prevention effectiveness after the incident. Ensure all steps are documented for audit and regulatory review.", "Prevents misdirection fraud and supports auditability.", 10,
      "Call back to the phone number provided in a recent email or document to confirm instructions, relying on the most recent contact information. Track all calls, monitor for weak controls, and review for risks of attacker manipulation after restoration.", "Weak control; can be attacker-controlled and may not prevent fraud.", 5,
      "Accept emailed instructions from familiar or previously used addresses, processing changes based on sender recognition alone. Track all communications, monitor for spoofing risks, and review for effectiveness after the incident.", "Spoofing risk; may allow fraudulent changes.", -5,
      "Skip all verification checks to expedite processing, making changes to payout instructions without additional review. Track all changes, monitor for loss risks, and review for missed opportunities after restoration.", "Loss risk; exposes the organization to fraud and regulatory penalties.", -5
    )),
    q("Loans", "How should the Loans department communicate with borrowers whose accounts may have been impacted by the insider fraud incident?", buildChoices(
      "Use standardized scripts that provide factual updates, outline the steps being taken, and offer a clear escalation path for impacted borrowers. Communicate consistently and defensibly, track all borrower communications, monitor for feedback, and review for effectiveness after the incident. Ensure all messaging is approved by Legal and Communications.", "Consistent, defensible, and supports customer trust.", 10,
      "Allow each lender to craft custom narratives for their borrowers, providing personalized messaging for each case. Track all communications, monitor for inconsistencies, and review for risks after restoration.", "Inconsistent and risky; may create confusion and legal exposure.", 5,
      "Promise accelerated loan approvals or special compensation as a remedy, offering expedited service to affected borrowers. Track all promises, monitor for credibility risks, and review for sustainability after the incident.", "Credibility risk; may create unrealistic expectations and reputational harm.", -5,
      "Avoid all communication with impacted borrowers to reduce noise, pausing outreach until the incident is resolved. Track all cases, monitor for confusion and customer churn, and review for missed opportunities after restoration.", "Confusion and churn; damages trust and may violate regulatory requirements.", -5
    )),
    ...
    q("Accounting", "If suspicious adjustments are discovered in the General Ledger (GL) during an insider fraud incident, what is the most transparent and defensible way to handle them?", buildChoices(
      "Promptly identify all impacted accounts, reverse or segregate suspicious entries, and require documented approvals for every adjustment. Communicate new procedures to all Accounting staff, track every change in a central log, and review for transparency and auditability throughout the incident. Ensure all actions are documented for regulatory and audit review.", "Transparent, auditable, and supports regulatory compliance.", 10,
      "Net all suspicious changes together to simplify the presentation, combining multiple entries for easier review. Track all adjustments, monitor for misstatement risks, and review for accuracy after restoration.", "Misstatement risk; may obscure the true impact and create audit issues.", 5,
      "Delay all entries and adjustments until the investigation is complete, postponing reporting until a full review is finished. Document the rationale, monitor for late or inaccurate records, and review for missed opportunities after the incident.", "Late/inaccurate reporting; may violate regulatory requirements.", -5,
      "Allow manual overrides and adjustments with no logging or documentation, permitting changes without record-keeping. Track all changes, inform management of risks, and review for audit trail failures after restoration.", "Audit trail failure; creates significant regulatory and audit risk.", -5
    )),
    q("Accounting", "After insider fraud is suspected, which reconciliations should Accounting prioritize, and how should this be managed?", buildChoices(
      "Prioritize reconciliation of cash, suspense, and inter-system tie-outs where suspicious adjustments occurred, documenting all findings and actions in detail. Communicate these priorities to the team, track progress in a central log, and review for material risks before moving to other reconciliations. Ensure all steps are audit-ready and defensible.", "Targets highest material risk and supports auditability.", 10,
      "Reconcile only cash accounts initially and defer other reconciliations to the next month, focusing on liquid assets first. Document the approach, monitor for partial visibility, and plan to address remaining reconciliations as resources allow.", "Partial visibility; may miss material risks in other accounts.", 5,
      "Skip all reconciliations to avoid drawing attention to the incident, postponing review to minimize scrutiny. Track all decisions, monitor for findings, and review for missed opportunities after restoration.", "Findings likely; increases risk of undetected issues.", -5,
      "Adjust entries to match expected outcomes or management preferences, modifying records to align with anticipated results. Track all changes, monitor for manipulation risks, and review for accuracy after the incident.", "Manipulation risk; undermines integrity and auditability.", -5
    )),
    q("Accounting", "What is the best way to preserve evidence for examiners and auditors during and after an insider fraud investigation?", buildChoices(
      "Maintain a central, access-controlled evidence index with documented approvals, timestamps, and direct links to all relevant artifacts for examiners and auditors. Communicate evidence preservation procedures to all staff, review logs regularly for completeness, and ensure all documentation is defensible for audit and regulatory review throughout the incident.", "Defensible for audit/regulators; supports transparency and compliance.", 10,
      "Archive relevant email threads and documents loosely, instructing staff to save communications in shared folders without a formal structure. Track completeness, inform compliance of the approach, and review for gaps after restoration.", "Messy and incomplete; may result in missing or disorganized evidence.", 5,
      "Rely on verbal approvals and undocumented decisions for evidence handling, allowing key actions to be made without written records. Monitor for weak evidence, document any issues, and plan to strengthen approval processes once normal operations resume.", "Weak evidence; may not withstand audit or legal scrutiny.", -5,
      "Delete all drafts and interim documentation after manual work is completed, removing temporary records to reduce storage needs. Record the rationale, inform relevant teams, and review for regulatory risks after the incident.", "Regulatory risk; may result in loss of critical evidence.", -5
    )),
    ...
    q("Deposits", "If suspicious customer-impacting activity is detected during an insider fraud incident, what is the most effective and fair way to handle these cases?", buildChoices(
      "Place holds on affected accounts per established policy, escalate all suspicious cases to the incident response team, and document every action thoroughly. Communicate updated procedures to all Deposits staff, track each case in a central system, and review for protection and fairness throughout the incident. Ensure all actions are audit-ready and defensible for regulatory review.", "Balances protection, fairness, and regulatory compliance.", 10,
      "Allow all customer activity to proceed without restriction to avoid complaints, permitting transactions even if suspicious. Track all activity, monitor for loss and compliance risks, and review for effectiveness after restoration.", "Loss and compliance risk; may result in regulatory penalties and customer harm.", 5,
      "Let each branch decide how to handle cases ad-hoc, allowing locations to manage suspicious activity independently without scripts or guidance. Track all decisions, monitor for inconsistencies, and review for risks after the incident.", "Inconsistent and risky; may create fairness and compliance issues.", -5,
      "Disclose the implicated employee’s identity to customers to explain delays or issues, sharing personal details as justification. Track all communications, inform management of privacy and legal risks, and review for appropriateness after restoration.", "Privacy/legal risk; may violate confidentiality and create reputational harm.", -5
    )),
    q("Deposits", "What should frontline scripts emphasize when communicating with customers during an insider fraud incident?", buildChoices(
      "Frontline scripts should emphasize verification steps, provide factual updates about the situation, and clearly outline where customers can get help or escalate concerns. Communicate the guidance to all staff, track every customer interaction, and review for confusion and escalation risks throughout the incident. Ensure all messaging is approved by Legal and Communications.", "Reduces confusion, escalations, and supports customer trust.", 10,
      "Reassure customers that everything is fine without providing any details, offering general comfort but no specifics. Track customer reactions, monitor for credibility risks, and review for effectiveness after restoration.", "Credibility risk; may create suspicion and erode trust.", 5,
      "Share internal investigation notes or behind-the-scenes information with customers if asked, providing details about the ongoing process. Track all communications, inform management of risks, and review for appropriateness after the incident.", "Inappropriate and risky; may compromise the investigation and privacy obligations.", -5,
      "Encourage customers to post online for updates or to share their experiences publicly, directing them to social media for information. Track all posts, monitor for uncontrolled messaging, and review for impacts after restoration.", "Uncontrolled messaging; may create reputational and compliance risks.", -5
    )),
    q("Deposits", "If customers are affected by the insider fraud incident, how often should external status updates be provided, and what should these updates include?", buildChoices(
      "Provide external status updates at a regular, predictable cadence with confirmed facts, next steps, and contact information for support. Track all communications, monitor for trust-building, and review for effectiveness after the incident. Ensure all updates are approved by Legal and Communications and are audit-ready.", "Predictable, trust-building, and supports customer confidence.", 10,
      "Update customers only if there is breaking news or major developments, limiting communications to significant events. Track call volume, monitor for unpredictability, and review for impacts after restoration.", "Unpredictable; may increase customer inquiries and frustration.", 5,
      "Provide constant updates with speculation and unconfirmed information to show action, sharing details as they become available. Track all communications, monitor for noise and mistakes, and review for effectiveness after the incident.", "Noise and mistakes; may create confusion and reputational harm.", -5,
      "Share only internal status updates, keeping customers uninformed during the incident and providing no external communication. Track all decisions, monitor for customer frustration, and review for service impacts after restoration.", "Customers remain uninformed; may damage trust and violate regulatory requirements.", -5
    )),
  ]
};
...
const SCENARIO_LIQUIDITY = {
  ...
  questions: [
    ...
    q("CEO/SVPs", "What is the immediate leadership communication strategy?", buildChoices(
      "Share a calm, factual statement with a clear update schedule and contact information, ensuring all stakeholders are informed and reassured throughout the incident. Track feedback, update messaging as needed, and review for effectiveness after restoration. Track all actions, monitor for narrative control and panic reduction, and review for effectiveness after restoration.", "Controls narrative and reduces panic.", 10,
      "Release a short holding statement to acknowledge the situation, followed by a planned, detailed message that outlines next steps and provides contact information for further questions. Track all communications, monitor for effectiveness and cadence, and review for improvements after restoration. Track all actions, monitor for narrative control and panic reduction, and review for effectiveness after restoration.", "Better than silence, but less effective without cadence detail.", 5,
      "Announce legal action as the first response to rumors, making a public statement that addresses the situation, outlines intended actions, and provides a schedule for future updates to all parties. Track all statements, monitor for impacts and narrative control, and review for effectiveness after restoration. Track all actions, monitor for narrative control and panic reduction, and review for effectiveness after restoration.", "Often inflames situation and distracts from reassurance.", -5,
      "Stay silent and close comments to avoid attention, refraining from any public statements while monitoring the situation and preparing to respond if further developments occur. Track all decisions, monitor for rumor growth and narrative control, and review for effectiveness after restoration. Track all actions, monitor for narrative control and panic reduction, and review for effectiveness after restoration.", "Looks evasive; rumors grow.", -5
    )),
    q("CEO/SVPs", "How should leadership coordinate governance today?", buildChoices(
      "Start a crisis command group with department leads and regular checkpoints, ensuring all decisions are aligned and communicated clearly to every team throughout the incident. Track all meetings, monitor for alignment and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for alignment and effectiveness, and review for effectiveness after restoration.", "Fast alignment and consistent decisions.", 10,
      "Hold daily executive updates and allow departments to act independently, providing a structure for information sharing while letting each group manage its own response and report progress. Track all updates, monitor for conflicts and effectiveness, and review for improvements after restoration. Track all actions, monitor for alignment and effectiveness, and review for effectiveness after restoration.", "Some coordination, but decisions can conflict.", 5,
      "Meet with executives only, without operational leads involved, focusing on high-level strategy and decision-making while relying on department heads to implement actions and communicate with their teams. Track all decisions, monitor for missed realities and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for alignment and effectiveness, and review for effectiveness after restoration.", "Misses branch/call center realities.", -5,
      "Let vendors lead all communications and decisions, giving external partners control over messaging and coordination, while internal teams follow guidance and report outcomes as directed. Track all communications, monitor for misalignment and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for alignment and effectiveness, and review for effectiveness after restoration.", "Loss of control and misaligned priorities.", -5
    )),
    q("CEO/SVPs", "Do you adjust branch cash policy immediately?", buildChoices(
      "Set temporary limits on cash withdrawals, provide scripts for staff, and define escalation steps, ensuring consistency and clear communication with customers at every branch during the incident. Track all transactions, monitor for liquidity and service impacts and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for liquidity and service impacts and effectiveness, and review for effectiveness after restoration.", "Consistency protects liquidity and service.", 10,
      "Adjust policy only for very large withdrawals as needed, allowing flexibility for exceptional cases while maintaining standard procedures for most transactions and providing guidance to staff. Track all exceptions, monitor for inconsistency and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for liquidity and service impacts and effectiveness, and review for effectiveness after restoration.", "Helps but may still create inconsistency.", 5,
      "Close branches to reduce cash demand right away, implementing a shutdown of operations and communicating the decision to customers, with plans for reopening and updates as the situation evolves. Track all closures, monitor for panic and rumor impacts and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for liquidity and service impacts and effectiveness, and review for effectiveness after restoration.", "Worsens panic and rumor.", -5,
      "Let each branch set its own policy for withdrawals, giving managers discretion to respond to local conditions, while providing general guidelines and support for handling customer requests. Track all policies, monitor for escalations and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for liquidity and service impacts and effectiveness, and review for effectiveness after restoration.", "Inconsistent; escalations rise.", -5
    )),

    // IT/Security (3)
    q("IT/Security", "What’s the IT priority with traffic spikes?", buildChoices(
      "Monitor and scale online banking systems, prepare DDoS protections, and ensure all technical teams are ready to respond to increased traffic and potential threats throughout the incident. Track all actions, monitor for outages and access issues and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for outages and access issues and effectiveness, and review for effectiveness after restoration.", "Prevents outages and protects access.", 10,
      "Increase monitoring and prepare to scale if thresholds are hit, coordinating with IT and security teams to address any spikes in activity and maintain system stability as needed. Track all monitoring, monitor for late responses and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for outages and access issues and effectiveness, and review for effectiveness after restoration.", "Helpful, but may be late without proactive scaling.", 5,
      "Disable protections to reduce friction, allowing easier access for users but increasing the risk of security exposure and potential system compromise during high traffic periods. Track all changes, monitor for exposure and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for outages and access issues and effectiveness, and review for effectiveness after restoration.", "Creates security exposure during chaos.", -5,
      "Block all logins temporarily, restricting access for all users while the situation is assessed and technical teams work to resolve issues and restore normal operations. Track all blocks, monitor for panic and customer impact and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for outages and access issues and effectiveness, and review for effectiveness after restoration.", "Amplifies panic and customer impact.", -5
    )),
    q("IT/Security", "How do you monitor for fraud during chaos?", buildChoices(
      "Increase fraud monitoring, implement rate limits, and conduct alert triage, ensuring all suspicious activity is reviewed and addressed promptly by the security team throughout the incident. Track all alerts, monitor for losses and response effectiveness and effectiveness, and review for improvements after restoration. Track all actions, monitor for losses and response effectiveness and effectiveness, and review for effectiveness after restoration.", "Reduces losses and supports response.", 10,
      "Keep current monitoring in place but add manual review for high-risk activity, assigning staff to focus on specific cases and report findings to leadership for further action. Track all reviews, monitor for scalability and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for losses and response effectiveness and effectiveness, and review for effectiveness after restoration.", "Better, but slower and less scalable.", 5,
      "Turn off alerts to reduce noise, minimizing distractions for staff but creating blind spots for potential attacks and increasing the risk of undetected fraudulent activity. Track all changes, monitor for blind spots and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for losses and response effectiveness and effectiveness, and review for effectiveness after restoration.", "Creates blind spots for attacks.", -5,
      "Share admin tools widely to speed up work, giving more staff access to critical systems but increasing the risk of security breakdowns and unauthorized actions during the response. Track all access, monitor for breakdowns and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for losses and response effectiveness and effectiveness, and review for effectiveness after restoration.", "Security breakdown.", -5
    )),
    q("IT/Security", "How should you handle customer status comms technically?", buildChoices(
      "Maintain a single status page with verified updates, ensuring all customers have access to accurate information and regular notifications about the incident and its resolution. Track all updates, monitor for call volume and misinformation and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for call volume and misinformation and effectiveness, and review for effectiveness after restoration.", "Reduces call volume and misinformation.", 10,
      "Post updates on the website homepage only, providing general information to visitors but lacking the structure and detail of a dedicated status page for ongoing communication. Track all posts, monitor for effectiveness and improvements, and review for improvements after restoration. Track all actions, monitor for call volume and misinformation and effectiveness, and review for effectiveness after restoration.", "Helpful, but less structured than a status page.", 5,
      "No updates until resolved, withholding all information from customers until the incident is fully addressed and normal operations are restored, which may increase speculation and concern. Track all decisions, monitor for speculation and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for call volume and misinformation and effectiveness, and review for effectiveness after restoration.", "Speculation grows.", -5,
      "Allow anyone to post updates, giving staff and customers the ability to share information freely but increasing the risk of misinformation and confusion during the incident. Track all posts, monitor for misinformation and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for call volume and misinformation and effectiveness, and review for effectiveness after restoration.", "Misinformation risk.", -5
    )),

    // HR (3)
    q("HR", "How should staffing be handled at branches today?", buildChoices(
      "Implement surge staffing and rotation schedules, provide de-escalation guidance, and ensure all branches have adequate coverage and support throughout the incident. Track all schedules, monitor for safety and service impacts and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for safety and service impacts and effectiveness, and review for effectiveness after restoration.", "Safer environment and better service.", 10,
      "Add a few float staff where possible, supplementing regular teams with additional personnel to help meet increased demand and maintain service quality during peak periods. Track all staffing, monitor for peak demand and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for safety and service impacts and effectiveness, and review for effectiveness after restoration.", "Helps, but may not meet peak demand.", 5,
      "Force overtime with no breaks, requiring all staff to work extended hours without rest, which may lead to burnout, increased safety risks, and reduced effectiveness over time. Track all schedules, monitor for burnout and safety risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for safety and service impacts and effectiveness, and review for effectiveness after restoration.", "Burnout and safety risk.", -5,
      "Send everyone home to reduce conflict, closing branches and suspending operations, which may result in service failures and fuel further rumors among customers and staff. Track all closures, monitor for service failure and rumor impacts and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for safety and service impacts and effectiveness, and review for effectiveness after restoration.", "Service failure fuels rumor.", -5
    )),
    q("HR", "What should HR tell employees about public rumor discussions?", buildChoices(
      "Remind employees of the social media policy, instructing them not to speculate and to refer all questions to official communications, ensuring consistent messaging and reducing misinformation risk. Track all communications, monitor for PR risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for PR risk and effectiveness, and review for effectiveness after restoration.", "Prevents misinformation and PR risk.", 10,
      "Suggest staff avoid social media during the incident, recommending that employees limit their online activity and refrain from posting about the situation until further notice. Track all suggestions, monitor for referral guidance and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for PR risk and effectiveness, and review for effectiveness after restoration.", "Some benefit, but still lacks clear referral guidance.", 5,
      "Allow staff to respond freely online, giving employees the freedom to share their thoughts and experiences about the incident, which may result in inconsistent information and increased PR risk. Track all posts, monitor for PR risk and inconsistent info and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for PR risk and effectiveness, and review for effectiveness after restoration.", "High PR risk; inconsistent info.", -5,
      "Punish anyone who mentions it, enforcing strict disciplinary measures for any employee who discusses the incident publicly, which may chill reporting and worsen organizational culture. Track all disciplinary actions, monitor for reporting chills and culture impacts and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for PR risk and effectiveness, and review for effectiveness after restoration.", "Chills reporting and worsens culture.", -5
    )),
    q("HR", "How should HR support customer-facing staff under stress?", buildChoices(
      "Provide scripts for customer interactions, schedule regular breaks, offer escalation support, and implement a safety plan to help staff manage stress and maintain consistency during the incident. Track all support, monitor for incidents and consistency and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for incidents and consistency and effectiveness, and review for effectiveness after restoration.", "Reduces incidents and improves consistency.", 10,
      "Offer scripts for customer interactions but leave break scheduling to managers, providing some support while allowing flexibility in how staff manage their workload and stress. Track all schedules, monitor for uneven execution and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for incidents and consistency and effectiveness, and review for effectiveness after restoration.", "Some value, but uneven execution.", 5,
      "Tell staff to handle all issues on their own, giving them full responsibility for managing customer interactions and stress without additional support or guidance from HR. Track all issues, monitor for safety and consistency and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for incidents and consistency and effectiveness, and review for effectiveness after restoration.", "Unsafe and inconsistent.", -5,
      "Provide no support until next week, delaying all assistance and resources for customer-facing staff, which may lead to increased burnout, mistakes, and dissatisfaction. Track all delays, monitor for burnout and mistakes and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for incidents and consistency and effectiveness, and review for effectiveness after restoration.", "Burnout and mistakes increase.", -5
    )),

    // Finance (3)
    q("Finance", "What’s the first step to stabilize liquidity management?", buildChoices(
      "Increase the cadence of liquidity reporting and prepare contingency funding, ensuring all financial teams are aligned and ready to respond to changing conditions throughout the incident. Track all reports, monitor for confident and compliant decisions and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for confident and compliant decisions and effectiveness, and review for effectiveness after restoration.", "Enables confident, compliant decisions.", 10,
      "Keep the normal reporting cadence but add an executive summary, providing additional context and updates to leadership while maintaining standard procedures for financial oversight. Track all summaries, monitor for visibility and speed and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for confident and compliant decisions and effectiveness, and review for effectiveness after restoration.", "Some visibility but may be too slow.", 5,
      "Freeze all outgoing payments, halting all transactions and informing stakeholders of the decision, which may cause operational harm and increase panic among customers and staff. Track all freezes, monitor for harm and panic and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for confident and compliant decisions and effectiveness, and review for effectiveness after restoration.", "Operational harm and panic risk.", -5,
      "Stop cash ordering to save money, suspending all new cash requests and communicating the change to branches, which may worsen shortages and amplify the impact of rumors. Track all changes, monitor for shortages and rumor impact and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for confident and compliant decisions and effectiveness, and review for effectiveness after restoration.", "Worsens shortages and rumor impact.", -5
    )),
    q("Finance", "How do you prioritize payments today?", buildChoices(
      "Prioritize payments for critical operations, cash logistics, and security/infrastructure vendors first, ensuring the bank remains functional and stable throughout the incident. Track all payments, monitor for stability and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for stability and effectiveness, and review for effectiveness after restoration.", "Keeps bank functioning and stable.", 10,
      "Pay critical items as they arise with executive approval, reviewing each transaction individually and coordinating with leadership to maintain oversight and control. Track all approvals, monitor for speed and consistency and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for stability and effectiveness, and review for effectiveness after restoration.", "Works but slower and inconsistent.", 5,
      "Pay the smallest invoices first, processing low-value transactions ahead of larger ones and communicating the approach to vendors and staff, regardless of operational impact. Track all payments, monitor for alignment to criticality and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for stability and effectiveness, and review for effectiveness after restoration.", "Not aligned to criticality.", -5,
      "Stop all payments, suspending all outgoing transactions and notifying stakeholders of the decision, which may result in service collapse and increased risk for the organization. Track all stops, monitor for collapse risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for stability and effectiveness, and review for effectiveness after restoration.", "Service collapse risk.", -5
    )),
    q("Finance", "How should you track costs from this event?", buildChoices(
      "Create an incident cost center with required approvals and thorough documentation, ensuring all expenses are tracked accurately and are audit-ready for future review. Track all costs, monitor for accuracy and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for accuracy and effectiveness, and review for effectiveness after restoration.", "Audit-ready and accurate.", 10,
      "Track only vendor costs and estimate internal hours later, maintaining partial records and updating totals as more information becomes available, which may miss the true impact of the event. Track all records, monitor for completeness and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for accuracy and effectiveness, and review for effectiveness after restoration.", "Partial but may miss true impact.", 5,
      "Track all costs later from memory, relying on staff recollections to compile expense reports after the incident, which may result in inaccurate and incomplete records. Track all reports, monitor for accuracy and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for accuracy and effectiveness, and review for effectiveness after restoration.", "Inaccurate.", -5,
      "Hide costs across miscellaneous categories, dispersing expenses throughout various accounts to avoid scrutiny, which may create reporting integrity risks and complicate future audits. Track all entries, monitor for integrity risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for accuracy and effectiveness, and review for effectiveness after restoration.", "Reporting integrity risk.", -5
    )),

    // Loans (3)
    q("Loans", "How should loan disbursements proceed during volatility?", buildChoices(
      "Continue loan disbursements with heightened verification and clear communications, ensuring all transactions are reviewed and customers are kept informed throughout the period of volatility. Track all disbursements, monitor for service and risk impacts and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for service and risk impacts and effectiveness, and review for effectiveness after restoration.", "Balances service and risk.", 10,
      "Pause new disbursements but keep commitments, temporarily suspending new loans while honoring existing agreements and providing updates to affected customers and staff. Track all commitments, monitor for impacts and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for service and risk impacts and effectiveness, and review for effectiveness after restoration.", "Safer, but impacts customers and revenue.", 5,
      "Rush approvals to keep volume up, expediting the loan process and increasing the number of disbursements, which may raise the risk of fraud and credit losses for the institution. Track all approvals, monitor for fraud and credit risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for service and risk impacts and effectiveness, and review for effectiveness after restoration.", "Fraud/credit risk increases.", -5,
      "Let lenders bypass controls, allowing staff to process loans without standard checks and balances, which may result in compliance failures and increased risk exposure. Track all exceptions, monitor for compliance failure and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for service and risk impacts and effectiveness, and review for effectiveness after restoration.", "Compliance failure.", -5
    )),
    q("Loans", "What borrower messaging is appropriate?", buildChoices(
      "Use a standard message that explains what borrowers can expect, provides an escalation path, and ensures all communications are consistent and clear throughout the incident. Track all messages, monitor for complaints and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for complaints and effectiveness, and review for effectiveness after restoration.", "Consistency reduces complaints.", 10,
      "Tell borrowers that processing may be delayed, providing an honest update about potential slowdowns and offering guidance on what steps to take if they have concerns or questions. Track all communications, monitor for vagueness and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for complaints and effectiveness, and review for effectiveness after restoration.", "True but can be too vague without next steps.", 5,
      "Promise faster approvals to calm borrowers, assuring them that their applications will be expedited, even if this creates a risk of overpromising and damaging credibility if delays occur. Track all promises, monitor for credibility risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for complaints and effectiveness, and review for effectiveness after restoration.", "Overpromise creates credibility risk.", -5,
      "Provide no communication to borrowers, withholding all updates and information about the status of their loans, which may lead to confusion and increased customer churn. Track all cases, monitor for churn and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for complaints and effectiveness, and review for effectiveness after restoration.", "Confusion increases churn.", -5
    )),
    q("Loans", "What control do you add during high chaos?", buildChoices(
      "Implement dual control on exceptions and use a verification checklist, ensuring all high-risk transactions are reviewed by multiple staff and documented thoroughly during periods of chaos. Track all controls, monitor for fraud and errors and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for fraud and errors and effectiveness, and review for effectiveness after restoration.", "Reduces fraud and errors.", 10,
      "Require manager review on exceptions only, assigning oversight to supervisors for unusual cases while allowing standard transactions to proceed with less scrutiny. Track all reviews, monitor for process gaps and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for fraud and errors and effectiveness, and review for effectiveness after restoration.", "Helps, but may miss process gaps.", 5,
      "Skip controls to move fast, removing standard checks and procedures to expedite processing, which may increase the likelihood of losses and audit findings for the organization. Track all changes, monitor for losses and findings and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for fraud and errors and effectiveness, and review for effectiveness after restoration.", "Losses and findings likely.", -5,
      "Email sensitive documents freely, allowing staff to share confidential information without restrictions, which may create privacy and compliance risks for the institution. Track all emails, monitor for privacy and compliance risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for fraud and errors and effectiveness, and review for effectiveness after restoration.", "Privacy/compliance risk.", -5
    )),

    // Accounting (3)
    q("Accounting", "How do you reflect unusual cash movement in reporting?", buildChoices(
      "Report the daily cash position with full reconciliations and detailed notes, providing leadership with accurate visibility and supporting decision-making throughout the incident. Track all reports, monitor for visibility and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for visibility and effectiveness, and review for effectiveness after restoration.", "Accurate visibility for leadership.", 10,
      "Provide daily summary numbers without full reconciliation, offering a general overview of cash movement but risking inaccurate decisions due to incomplete information. Track all summaries, monitor for accuracy and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for visibility and effectiveness, and review for effectiveness after restoration.", "Some signal, but risk inaccurate decisions.", 5,
      "Switch to weekly reporting only, reducing the frequency of updates and potentially delaying the identification of issues during periods of unusual cash movement. Track all reports, monitor for speed and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for visibility and effectiveness, and review for effectiveness after restoration.", "Too slow during a run.", -5,
      "Suppress negative indicators in reports, omitting unfavorable data to present a more positive outlook, which may create governance and ethics risks for the organization. Track all changes, monitor for governance and ethics risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for visibility and effectiveness, and review for effectiveness after restoration.", "Governance and ethics risk.", -5
    )),
    q("Accounting", "What’s the priority reconciliation during heavy cash activity?", buildChoices(
      "Reconcile branch cash, vault/ATM settlements, and general ledger tie-outs as a priority, ensuring all material breaks are caught quickly and addressed during periods of heavy cash activity. Track all reconciliations, monitor for material breaks and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for material breaks and effectiveness, and review for effectiveness after restoration.", "Catches material breaks quickly.", 10,
      "Reconcile branch cash only, focusing on a single area and providing partial coverage, which may miss settlement issues and create gaps in financial oversight. Track all reconciliations, monitor for coverage and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for material breaks and effectiveness, and review for effectiveness after restoration.", "Partial coverage; may miss settlement issues.", 5,
      "Skip reconciliations until month-end, delaying all reviews and allowing the backlog to compound, which may increase risk and make it harder to resolve discrepancies later. Track all delays, monitor for backlog risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for material breaks and effectiveness, and review for effectiveness after restoration.", "Backlog compounds risk.", -5,
      "Allow unlogged adjustments, permitting staff to make changes without documentation, which may result in no audit trail and increased risk of errors or fraud. Track all adjustments, monitor for audit trail and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for material breaks and effectiveness, and review for effectiveness after restoration.", "No audit trail.", -5
    )),
    q("Accounting", "How do you maintain documentation for unusual transactions?", buildChoices(
      "Maintain a central evidence folder with required approvals and a detailed index, ensuring all documentation for unusual transactions is audit-ready and consistent across the organization. Track all documentation, monitor for consistency and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for consistency and effectiveness, and review for effectiveness after restoration.", "Audit-ready and consistent.", 10,
      "Keep notes individually and consolidate them later, allowing staff to maintain their own records before combining them, which may risk loss or inconsistency in documentation. Track all notes, monitor for loss and inconsistency and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for consistency and effectiveness, and review for effectiveness after restoration.", "Better than nothing, but risk loss/inconsistency.", 5,
      "Rely on only verbal approvals for unusual transactions, foregoing written documentation and creating insufficient evidence for future audits or reviews. Track all approvals, monitor for evidence sufficiency and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for consistency and effectiveness, and review for effectiveness after restoration.", "Insufficient evidence.", -5,
      "Delete messy records later, removing incomplete or disorganized documentation after the fact, which may create regulatory risk and hinder future investigations. Track all deletions, monitor for regulatory risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for consistency and effectiveness, and review for effectiveness after restoration.", "Regulatory risk.", -5
    )),

    // Deposits (3)
    q("Deposits", "How do you manage large withdrawal requests at branches?", buildChoices(
      "Set policy limits on large cash withdrawals and schedule pickups, ensuring fairness and liquidity control at all branches while communicating procedures to staff and customers. Track all withdrawals, monitor for fairness and liquidity and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for fairness and liquidity and effectiveness, and review for effectiveness after restoration.", "Fairness and liquidity control.", 10,
      "Allow withdrawals but require manager approval over a set threshold, providing oversight for larger transactions and helping maintain consistency, though some variation may still occur without scripts. Track all approvals, monitor for consistency and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for fairness and liquidity and effectiveness, and review for effectiveness after restoration.", "Helps, but can still be inconsistent without scripts.", 5,
      "Honor all withdrawal requests immediately, processing every transaction as it comes in, which may increase the risk of cash depletion and create challenges for branch operations. Track all requests, monitor for depletion risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for fairness and liquidity and effectiveness, and review for effectiveness after restoration.", "Cash depletion risk.", -5,
      "Let each branch decide its own approach to large withdrawals, giving managers discretion but increasing the risk of inconsistency and potential issues across locations. Track all policies, monitor for inconsistency and risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for fairness and liquidity and effectiveness, and review for effectiveness after restoration.", "Inconsistent and risky.", -5
    )),
    q("Deposits", "How do you handle call center pressure and messaging?", buildChoices(
      ...
      "Add scripts for staff but keep the phone tree the same, offering some support for customer interactions but maintaining the existing call routing, which may result in high volume without automation. Track all calls, monitor for volume and automation and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for load and messaging consistency and effectiveness, and review for effectiveness after restoration.", "Helpful, but still high volume without automation.", 5,
      "Turn phones off during periods of high pressure, suspending all incoming calls and communications, which may worsen panic and leave customers without support. Track all decisions, monitor for panic and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for load and messaging consistency and effectiveness, and review for effectiveness after restoration.", "Worsens panic.", -5,
      "Tell customers everything is fine without providing facts, offering vague reassurances that may damage credibility and increase confusion among callers. Track all communications, monitor for credibility risk and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for load and messaging consistency and effectiveness, and review for effectiveness after restoration.", "Credibility risk.", -5
    )),
    q("Deposits", "What is the best customer reassurance tactic?", buildChoices(
      "Provide transparent updates, explain what customers can do, and direct them to where they can check status, building trust and offering practical support throughout the incident. Track all updates, monitor for trust-building and practicality and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for trust-building and practicality and effectiveness, and review for effectiveness after restoration.", "Trust-building and practical.", 10,
      "Encourage customers to visit a branch for updates, offering in-person reassurance and information, though this may increase branch load and create additional challenges for staff. Track all visits, monitor for branch load and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for trust-building and practicality and effectiveness, and review for effectiveness after restoration.", "Some reassurance, but increases branch load.", 5,
      "Maintain silence and provide no updates or information to customers, which may lead to increased speculation, confusion, and dissatisfaction during the incident. Track all decisions, monitor for speculation and confusion and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for trust-building and practicality and effectiveness, and review for effectiveness after restoration.", "Speculation grows.", -5,
      "Blame customers for panic, attributing the situation to their actions and communications, which may cause reputational harm and damage relationships with the community. Track all communications, monitor for reputational harm and effectiveness, and review for effectiveness after restoration. Track all actions, monitor for trust-building and practicality and effectiveness, and review for effectiveness after restoration.", "Reputational harm.", -5
    )),
  ]
};
