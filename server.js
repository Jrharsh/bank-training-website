// ENHANCED Game Scenario Generation - Replace the existing /api/generate-scenario endpoint in server.js
    ...
    try {
        ...
        const departmentContexts = {
            'CEO_SVPs': {
                ...
                questionTypes: [
                    'How do you communicate this crisis to the board of directors?',
                    'What is your strategy for managing public perception during this crisis?',
                    'How do you prioritize resource allocation across departments during this emergency?'
                ]
            },
            'IT_Security': {
                name: 'IT/Security',
                ...
                questionTypes: [
                    'What immediate technical security measures should be implemented?',
                    'How do you prioritize system recovery to restore critical banking functions?',
                    'What is your strategy for preventing further security breaches during this incident?'
                ]
            },
            'HR': {
                name: 'HR',
                ...
                questionTypes: [
                    'How do you ensure employee safety and communicate with staff during this crisis?',
                    'What staffing adjustments are needed to maintain critical operations?',
                    'How do you maintain employee morale and productivity during this emergency?'
                ]
            },
            'Finance': {
                name: 'Finance',
                ...
                questionTypes: [
                    'How do you assess and manage the immediate financial impact of this crisis?',
                    'What emergency funding or liquidity measures need to be activated?',
                    'How do you handle financial reporting and disclosure requirements during this event?'
                ]
            },
            'Loans': {
                name: 'Loans',
                ...
                questionTypes: [
                    'How do you manage loan portfolio risk and borrower communications during this crisis?',
                    'What emergency lending policies should be implemented in response to this situation?',
                    'How do you handle regulatory compliance for lending operations during this emergency?'
                ]
            },
            'Accounting': {
                name: 'Accounting',
                ...
                questionTypes: [
                    'How do you maintain accurate financial reporting and regulatory compliance during this crisis?',
                    'What emergency accounting procedures need to be activated in response to this situation?',
                    'How do you handle audit requirements and documentation during this emergency?'
                ]
            },
            'Deposits': {
                name: 'Deposits',
                ...
                questionTypes: [
                    'How do you protect customer deposits and maintain customer confidence during this crisis?',
                    'What emergency procedures should be implemented for deposit operations in this situation?',
                    'How do you handle customer communications and service delivery during this emergency?'
                ]
            }
        };
...
function createEnhancedCrisisScenario(selectedScenario, departmentContexts) {
    ...
    const crisisQuestionTemplates = {
        ...
        // Add more crisis-specific templates as needed
    };
    ...
    departments.forEach(department => {
        ...
        const crisisQuestions = crisisQuestionTemplates[selectedScenario.type]?.[department] || 
                               deptInfo?.questionTypes || [
                                   `How should ${department} respond to this crisis?`,
                                   `What ${department} procedures should be activated?`,
                                   `How should ${department} coordinate with other departments?`
                               ];
...
function generateCrisisSpecificOption(department, crisisType, questionIndex, optionIndex, isCorrect) {
    const crisisSpecificOptions = {
        ...
        'regulatory_investigation': {
            correct: [
                'Immediately engage legal counsel and implement document preservation',
                'Cooperate fully with investigators while protecting legal rights',
                'Activate crisis communication plan for stakeholders and media'
            ],
            wrong: [
                'Deny all allegations publicly before investigation concludes',
                'Destroy potentially damaging documents to limit exposure',
                'Refuse to cooperate with investigators without court orders',
                'Hide information from board of directors to avoid panic'
            ]
        }
    };
