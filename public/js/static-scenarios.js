  ...
  questions: [
    ...
    q("Finance", "The $47 million in ACH transactions that were queued when systems went down include payroll files for 340 businesses representing 12,000 employees expecting direct deposits tomorrow. The ACH system won't be restored in time. What approach do you recommend?",
      buildChoices(
        ...
        5,
        "Ask businesses to arrange alternative payrolls through their backup providers and offer to reimburse reasonable fees where appropriate, while prioritizing the most critical employers for direct assistance.",
        ...
        -5,
        "Consider manual wires for the largest, highest-impact payrolls where controls permit, and publish clear eligibility and reconciliation procedures for manual processing.",
