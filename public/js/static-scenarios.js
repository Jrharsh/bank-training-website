...
const SCENARIO_RANSOMWARE = {
  ...
  questions: [
    ...
    q("Finance", "The $47 million in ACH transactions that were queued when systems went down include payroll files for 340 businesses representing 12,000 employees expecting direct deposits tomorrow. The ACH system won't be restored in time. What approach do you recommend?",
      buildChoices(
        "Prioritize outreach to the largest employers and those with imminent payroll deadlines; offer cashier's checks or expedited wires where verification allows, provide a short employer request form for expedited handling, and assign a single liaison for reconciliations and SLAs.",
        ...
        5,
        "Ask businesses to arrange alternative payrolls through their backups and offer to reimburse reasonable fees, while prioritizing the most critical employers for direct assistance.",
        ...
        -5,
        "Process the largest, highest-impact payrolls manually by wire where controls permit, and publish clear eligibility and reconciliation procedures for manual processing.",
  ...
  questions: [
    ...
    q("CEO/SVPs", "It's 7:15 AM and you're seeing alarming social media posts: a regional bank in your state was closed by regulators last night, and Twitter threads are claiming 'community banks are next.' Your branch managers are already texting - customers are lined up before opening asking to withdraw funds. Your online banking shows a 340% spike in login attempts. Local TV news is setting up outside your main branch. What's your immediate action?",
      buildChoices(
        ...
        5,
        "Post a brief, factual social update highlighting a couple of verified strength indicators and direct customers to official channels for updates while avoiding speculative language.",
        ...
        -5,
        "Prioritize operational steps: deploy cash and extend branch hours, while ensuring a minimal communications touchpoint so customers know where to get verified information.",
