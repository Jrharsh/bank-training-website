...
const SCENARIO_RANSOMWARE = {
  ...
  questions: [
    ...
    q("CEO/SVPs", "By noon, restoration estimates are 5-7 days. The ransom group sometimes provides working keys; insurance may cover payment; law enforcement recommends caution. Board members are split. How do you structure the board decision?",
      buildChoices(
        "Prepare a decision memo with legal and insurance considerations plus clear action thresholds for board approval.",
        ...
        4,
        "Recommend categorical refusal to pay ransom demands to signal principled opposition to criminal activity. This approach focuses all available resources on technical restoration efforts while maintaining ethical standards and potentially strengthening the bank's reputation for integrity with customers, regulators, and the broader financial community, even though restoration may take longer and cause extended customer inconvenience during the recovery period.",
        ...
        0,
        "Let senior technical and legal staff make the payment decision based on their specialized expertise and inform the board afterward.",
    ...
    q("CEO/SVPs", "A reporter from American Banker calls saying they've confirmed your systems are down and are running a story in two hours. They're asking whether this is a ransomware attack and whether customer data was stolen. Forensics hasn't completed data exfiltration analysis yet. How do you respond?",
      buildChoices(
        "Acknowledge service disruption, confirm investigation with law enforcement, and provide factual holding statement.",
        ...
        6,
        "Confirm publicly that this is a ransomware attack to demonstrate transparency and discourage rumor speculation, while acknowledging that data exfiltration details remain under active investigation by cybersecurity forensics experts and law enforcement agencies.",
        ...
        3,
        "Deny any security incident and attribute service disruptions to planned maintenance complications and routine system updates that encountered unexpected technical difficulties requiring extended resolution time. This protective approach avoids immediate reputational damage and negative market reaction while providing your technical team adequate time to complete their comprehensive response and restoration efforts without external pressure or premature disclosure of sensitive operational details.",
    ...
    q("IT/Security", "Active encryption is still spreading through network shares. You've identified the compromised service accounts but disabling them will break several production integrations. Your endpoint detection shows 340 infected endpoints and counting. What's your containment priority?",
      buildChoices(
        ...
        6,
        "Focus immediately on isolating and hardening backup and restore infrastructure to ensure reliable recovery capabilities, accepting that some production systems may continue operating under compromise for an extended period while recovery options are secured and validated.",
        ...
        4,
        "Order immediate full network disconnect and cease all integrations to completely eliminate lateral movement opportunities. This decisive action stops ransomware spread by severing all network connections and preventing further system compromise, though it causes severe operational disruption across all business functions and removes options for controlled recovery, detailed forensic evidence collection, and coordinated incident response activities during the critical containment phase.",
    ...
    q("IT/Security", "Forensics reports that your backup infrastructure appears clean, but they've found evidence the attackers had access to your environment for 3 weeks before deploying ransomware. Your most recent clean backup is 18 hours old but any backup from the past 3 weeks could contain dormant malware or compromised credentials. What's your restoration strategy?",
      buildChoices(
        ...
        5,
        "Choose an older pre-compromise backup from before the three-week window to guarantee a completely clean starting point, accepting substantial data loss and extensive operational disruption.",
        ...
        0,
        "Rebuild all systems completely from scratch to eliminate any possibility of dormant compromise while implementing enhanced security controls and modern architecture patterns. This comprehensive approach ensures zero residual risk from the compromised environment and provides valuable opportunities to implement significant security improvements and architectural modernization, even though it extends the recovery timeline into weeks and requires substantial operational planning, resource coordination, and careful stakeholder communication throughout the extended restoration period.",
    ...
    q("IT/Security", "Online banking restoration is technically ready but your security team hasn't completed penetration testing on the restored environment. Customer complaints are mounting - 47,000 customers have called the contact center today. Business leaders are pushing hard to restore service. What's your recommendation?",
      buildChoices(
        "Restore services in phases: read-only first, then controlled transactional functions with enhanced verification.",
        ...
        8,
        "Bring up full service immediately with enhanced monitoring and rapid rollback plan if suspicious activity is detected, accepting operational risk to prioritize customer access and restore normal banking operations.",
        ...
        5,
        "Keep services offline until complete security validation.",
        ...
        0,
        "Open limited transactional functionality exclusively for prioritized customers including high-value relationships and critical business accounts after implementing bespoke verification procedures and additional authentication requirements. This selective approach delays broader public restoration while meeting immediate needs of most important customer relationships and preserving resources for comprehensive security validation across all restored systems before general availability.",
    ...
    q("HR", "It's Day 2 and your IT security team has been working 20+ hour shifts. The CISO reports that two senior engineers are showing signs of severe fatigue - making configuration errors and forgetting steps in procedures. However, these engineers have critical institutional knowledge about the encrypted systems. Pulling them off could slow recovery significantly. What do you recommend?",
      buildChoices(
        ...
        7,
        "Allow engineers to self-manage breaks and supplement them with temporary oversight and spot-checks from senior managers to ensure critical tasks are completed correctly and safely.",
        ...
        2,
        "Immediately replace the fatigued engineers with external contractors or consulting specialists to maintain recovery momentum and operational speed. This approach accepts the onboarding and knowledge-transfer risks while ensuring that critical restoration work continues without interruption from human factors issues. The contractors' fresh perspective and energy can compensate for their lack of institutional knowledge during this critical phase, and you can provide accelerated briefings to help them understand the specific system architecture and recovery requirements.",
    ...
    q("HR", "Branch managers report that several employees are posting on social media about the outage, including one who wrote 'Management has no idea how bad this is - our systems are totally destroyed.' The posts are gaining attention. How should this be handled?",
      buildChoices(
        ...
        5,
        "Apply formal disciplinary measures to the poster(s) to deter further breaches of policy and establish clear consequences for unauthorized communications.",
        ...
        1,
        "Do nothing publicly and focus exclusively on private operational recovery efforts, allowing the social media issue to fade naturally as the technical situation improves and normal operations resume. This approach avoids drawing additional attention to the negative posts while concentrating all management effort and resources on resolving the underlying technical and operational problems that prompted the employee frustration and negative commentary in the first place.",
    ...
    q("HR", "Several employees have approached HR confidentially expressing fear that they'll be blamed or terminated for the security breach, even though there's no indication of employee fault. One employee who clicked a phishing link (not confirmed as the entry point) is particularly distressed. How do you address this?",
      buildChoices(
        "Issue blame-free message emphasizing recovery and learning, offer private support, run phishing awareness sessions.",
        ...
        5,
        "Request that managers compile lists of employees who may have been involved in risky actions and meet them individually to review behavior and compliance requirements.",
        "Proactive review can identify training gaps but risks creating a culture of suspicion and discouraging honest reporting.",
        0,
        "Announce that no one will face discipline for honest mistakes during the incident to ensure full cooperation with recovery and investigation efforts. This blanket amnesty policy removes fear-based barriers to information sharing and encourages employees to come forward with any details that might assist in understanding the incident timeline and attack vectors without worrying about personal consequences for their actions during this crisis period.",
    ...
    q("Finance", "It's Day 3 and customers are increasingly withdrawing funds from your operational branches and ATMs - daily outflows have tripled versus normal. Media speculation about the bank's viability is growing. Your liquidity coverage ratio is still well above regulatory minimums but trending down. What's your recommendation?",
      buildChoices(
        ...
        8,
        "Deliver targeted customer communication explaining service impacts and immediate mitigations. Stand up prioritized outreach for high-balance and vulnerable customers, equip call center with validated scripts, designate liaison for employer escalations, and coordinate discrete intraday liquidity actions under delegated Treasury authority.",
        ...
        7,
        "Maintain normal liquidity posture since ratios remain healthy and reacting visibly could signal weakness and accelerate outflows.",
    ...
    q("Finance", "The $47 million in ACH transactions that were queued when systems went down include payroll files for 340 businesses representing 12,000 employees expecting direct deposits tomorrow. The ACH system won't be restored in time. What approach do you recommend?",
      buildChoices(
        ...
        -5,
        "Consider manual wires for the largest, highest-impact payrolls where existing controls and approval procedures permit, and publish clear eligibility criteria and detailed reconciliation procedures for all manual processing activities to ensure proper documentation and audit trail maintenance throughout the expedited payment process.",
    ...
    q("Finance", "Your cyber insurance policy has a $500,000 retention and covers ransom payments, business interruption, and forensics costs. The adjuster is requesting extensive documentation, but your team is consumed with recovery operations. They've also asked whether the bank complied with all policy requirements regarding security controls. How do you manage the insurance relationship?",
      buildChoices(
        ...
        10,
        "Propose intake call with insurer and broker to agree phased documentation plan, request conditional interim payments for urgent costs, and assign liaison to manage queries while getting counsel review.",
        ...
        -5,
        "Focus entirely on recovery and address insurance documentation requirements after systems are fully restored and tested, since the policy will cover legitimate costs regardless of when the supporting documentation is ultimately submitted to the carrier for comprehensive review and processing.",
    ...
    q("Loans", "You have $23 million in loan disbursements scheduled for the next 48 hours, including several construction loans with funding deadlines tied to contractor schedules. Your loan origination system is encrypted and manual disbursement is possible but risky without normal controls. What's your approach?",
      buildChoices(
        ...
        7,
        "Stand up narrowly scoped manual disbursement led by senior credit officer with treasury sign-off: authorize time-critical construction draws through escrowed-release, require borrower confirmation, dual officer verification, and staff checklist.",
    ...
    q("Loans", "A large commercial borrower (a regional hospital with $45 million outstanding) calls demanding to draw their entire $15 million line of credit immediately, citing concerns about the bank's stability and their need to ensure operational funds. Their line is committed and they have a contractual right to draw. However, processing a $15 million manual disbursement carries significant operational and fraud risk. What do you recommend?",
      buildChoices(
        ...
        7,
        "Offer senior-led verification pathway that honors the facility: apply call-back protocols to known treasury contact, require treasury authorization, expedite fraud screening, implement settlement confirmation procedures, and issue written settlement confirmation with dedicated relationship contact.",
    ...
    q("Loans", "Mortgage closing scheduled for today can't proceed because title company can't verify the payoff amount on the existing loan from your core system. The borrowers have a moving truck loaded and their old house buyer's financing is contingent on this closing. Manual records suggest the payoff is approximately $287,000 but can't be verified to the penny. What do you advise?",
      buildChoices(
        ...
        10,
        "Provide documented conservative payoff estimate, and if title company requires stronger assurance, open short-term independent escrow with neutral trustee for disputed portion. Obtain borrower and title company sign-off on escrow terms.",
        ...
        -5,
        "Decline to provide any payoff information until systems are fully restored since providing inaccurate payoff amounts could create significant liability exposure for the bank and potentially result in regulatory violations regarding proper loan documentation and closure procedures. This conservative approach protects the bank from errors while ensuring full compliance with documented payoff requirements and maintaining audit trail integrity throughout the loan closure process.",
    ...
    q("Accounting", "Day 2 and your GL system is still encrypted. Staff are processing transactions using spreadsheets and manual logs. You estimate 4,000+ transactions have been processed outside normal systems. Some transaction details are incomplete. How do you maintain accounting control?",
      buildChoices(
        "Establish centralized manual transaction register with standardized fields, sequential numbering, and dual sign-off requirements.",
        ...
        10,
        "Adopt hybrid approach: require centralized capture for high-risk and customer-facing transactions using mandated template, sequential numbering, and scanned evidence; allow low-value items to be logged locally and batch-submitted daily.",
        ...
        5,
        "Suspend all non-essential transaction processing until GL is restored to minimize the volume of manual entries requiring reconciliation, but maintain prioritized customer-facing transactions under strict manual controls and escalate any exceptions immediately to senior management.",
        ...
        -5,
        "Focus resources on restoring GL rather than building parallel manual processes, accepting that some transaction detail may be lost but can be reconstructed from bank statements and source documents after the incident.",
    ...
    q("Accounting", "Your external auditors call asking about the incident's impact on your in-progress quarterly financial statement audit. They express concern about internal control reliance and ask whether the incident constitutes a material weakness. How do you respond?",
      buildChoices(
        "Propose initial focused briefing: incident timeline, effective controls, compensating controls, and prioritized impact list with named remediation owners and auditor liaison.",
        ...
        10,
        "Acknowledge the criminal nature and present focused briefing listing impacted control areas, interim compensating controls, objective evidence, named remediation owners with deadlines, and realistic timeline for normal operations.",
        ...
        5,
        "Ask auditors to postpone their evaluation until the incident is fully resolved so you can provide a complete picture rather than speculating about control implications while the situation remains fluid.",
        ...
        -5,
        "Provide auditors only the information they specifically request, avoiding volunteering details about control gaps or manual processing volumes that might raise additional concerns about the bank's operational resilience and internal controls during the crisis.",
    ...
    q("Accounting", "Month-end close is in 5 days. Critical systems won't be fully restored by then. Your close process normally involves 47 reconciliations, many requiring system data that's currently unavailable. What's your approach?",
      buildChoices(
        ...
        10,
        "Request targeted extensions only for specific reconciliations that materially cannot be completed, and propose concrete alternative close procedures agreed with auditors and clear timetable for finalization.",
        ...
        5,
        "Complete the close using best estimates everywhere systems data is unavailable, with a comprehensive plan to restate if material differences emerge once true data is available and validated.",
        ...
        -5,
        "Skip this month's close entirely and do a combined two-month close once systems are fully restored and tested, ensuring complete accuracy and comprehensive reconciliation of all transactions during the recovery period.",
    ...
    q("Deposits", "Branch lobbies are packed with anxious customers demanding to withdraw funds and close accounts. Wait times exceed 2 hours. Some customers are verbally abusing tellers, and two tellers have been reduced to tears. News cameras have arrived and are filming the lines. What immediate actions do you take?",
      buildChoices(
        "Deploy additional staff, assign rotating managers to triage and de-escalate, and authorize short teller breaks; issue coordinated holding statement.",
        ...
        5,
        "Temporarily close the most affected branches to protect staff while directing customers to nearby open branches, ATMs and a staffed hotline for urgent issues with trained representatives.",
    ...
    q("Deposits", "A major employer in your market (8,000 employees) contacts you saying they're considering moving their payroll account to a competitor because their employees didn't get paid due to your ACH failure. The account represents $24 million in average deposits. How do you handle this situation?",
      buildChoices(
        "Have senior executive call the employer's CFO personally to apologize, explain facts and remediation steps, and offer immediate remediation support where appropriate.",
        ...
        10,
        "Offer targeted remediation package: immediate provisional payroll support for impacted employees, dedicated account team to coordinate settlements, documented eligibility criteria, and short SLA for resolving claims.",
        ...
        5,
        "Explain that the incident was caused by criminal attackers and that no bank can guarantee immunity from such sophisticated attacks, emphasizing your strong track record and customer service before this unprecedented incident.",
        ...
        -5,
        "Accept that they'll likely leave and focus resources on retaining customers who haven't yet indicated they're considering leaving rather than chase lost relationships.",
    ...
    q("Deposits", "It's Day 4 and online banking is partially restored. Customers can view balances but some are seeing incorrect information - transactions that processed during the outage aren't reflected yet. Social media is exploding with customers posting screenshots of 'wrong' balances and speculating about lost money. How do you address this?",
      buildChoices(
        "Issue immediate multi-channel communication acknowledging that balance displays may be incomplete and provide estimated synchronization timeline.",
        ...
        10,
        "Publish concise multi-channel advisory explaining which balances may be incomplete, estimated sync timeline, staffed verification hotline with trained agents, and proactive outreach to high-balance or vulnerable customers.",
        ...
        5,
        "Take online banking back offline until all data is fully synchronized to avoid confusing customers with incorrect information that could cause additional panic and customer service inquiries.",
        ...
        -5,
        "Let customers know through the call center that they can call in to verify their actual balances but avoid public communications that might highlight the data synchronization issue and draw additional attention to the problem.",
...
const SCENARIO_LIQUIDITY = {
  ...
  questions: [
    ...
    q("CEO/SVPs", "It's 7:15 AM. Social posts claim a nearby bank was closed by regulators and customers are already lining up before opening. Online banking logins have spiked ~340% and local TV is arriving. What's your immediate action?",
      buildChoices(
        "Hold brief crisis leadership standup, ask Treasury to verify liquidity, and issue short factual message and branch talking points.",
        ...
        5,
        "Post a brief factual update highlighting a couple of verified strength indicators and point customers to official channels for additional details and verified information.",
        ...
        -5,
        "Focus on immediate operations — deploy cash and extend branch hours — and provide a minimal communications note about where to get verified information without detailed explanations.",
    ...
    q("CEO/SVPs", "By noon the morning rush is handled but withdrawals are 8× normal. Treasury warns that if this pace continues three days you may need to draw contingency credit. A board member, a reporter, and your regulator are requesting updates. How do you prioritize?",
      buildChoices(
        "Brief the board with facts, promptly update the regulator with the same information, and provide concise spokesperson statement to the reporter.",
        ...
        5,
        "Decline the reporter interview and concentrate on the board and regulator to avoid media amplification that could worsen the situation and customer panic.",
        ...
        -5,
        "Delegate all three communications to others so you can remain focused on operations and crisis management during this critical period.",
    ...
    q("IT/Security", "A 340% spike in logins is causing slow page loads and timeouts, which fuels a 'locked out' narrative. Adding server capacity will take 4–6 hours; rate limiting could slow heavy/malicious traffic sooner. What do you do?",
      buildChoices(
        "Start capacity expansion while deploying targeted rate limiting to reduce automated traffic and preserve normal customer access; communicate briefly about high volume.",
        ...
        5,
        "Implement aggressive rate limiting immediately to stabilize the system; customers can tolerate slower responses during this temporary high-traffic period.",
        ...
        -5,
        "Treat performance as non-urgent and address it during the normal change window tonight to avoid making hasty system changes during the crisis.",
  ...
  questions: [
    ...
    q("CEO/SVPs", "Your wire operations supervisor calls with concerning news: a $847,000 wire transfer was requested via email from your largest construction vendor requesting a change to their banking instructions. The email came from the vendor's actual email address but your dual-control process flagged it because the payment amount doesn't match open invoices. The wire hasn't been sent yet. Your accounts payable clerk is certain the email is legitimate because she recognizes the signature block. What would you instruct the team to do first?",
      buildChoices(
        ...
        5,
        "Allow the payment to proceed since dual control exists and the amount can be recovered if it's fraud - maintaining vendor relationships is important and customer service should be the priority.",
        ...
        -5,
        "Have the clerk call the number in the email signature to verify before making a decision, since she has the established relationship with this vendor and understands their normal communication patterns.",
...
const SCENARIO_REG_EXAM = {
  ...
  questions: [
    ...
    q("CEO/SVPs", "Saturday morning, your board chair calls asking why they weren't notified Friday evening about the examination. They learned about it from another board member who heard from a bank employee. The board chair is upset about the communication breakdown and wants to know the plan. How do you handle this?",
      buildChoices(
        "Apologize for the communication gap and brief them on exam scope, risks, and your preparation plan.",
        ...
        10,
        "Explain that you were intensely focused on critical preparation activities Friday evening, including coordinating with senior managers, reviewing document readiness, and developing action plans for known deficiencies. You had planned to provide a comprehensive board briefing Monday morning before examiners arrived to ensure you could present complete information rather than preliminary assessments.",
        ...
        5,
        "Point out that the board member who shared confidential examination information violated established protocols for handling regulatory notifications, which could compromise the bank's relationship with regulators if information spreads beyond authorized governance channels before appropriate preparations are complete.",
        ...
        -5,
        "Suggest that regulatory examinations are fundamentally operational matters that should be managed by executive leadership, and that board involvement should appropriately wait until there are concrete findings and recommendations to discuss rather than preliminary concerns that may not materialize into formal issues.",
    ...
    q("CEO/SVPs", "On Day 2 of the exam, the Examiner-in-Charge requests a private meeting with you. She expresses concern that several document requests haven't been fulfilled, staff seem unprepared for interviews, and the acting BSA Officer couldn't answer basic questions about transaction monitoring. She asks whether the bank is taking the examination seriously. How do you respond?",
      buildChoices(
        "Acknowledge the concerns, own the gaps, and commit to immediate remediation. Ask what would demonstrate seriousness.",
        ...
        10,
        "Explain that the extraordinarily short notice made adequate preparation virtually impossible given the complexity of modern banking operations, the need to coordinate multiple departments, and the challenge of addressing staffing gaps. The bank shouldn't be judged solely on Day 2 performance when industry standards typically allow more preparation time for comprehensive examinations.",
        ...
        5,
        "Assure her that the bank takes the regulatory examination process very seriously and that any apparent gaps are merely temporary operational issues that will be comprehensively resolved once we have adequate time to implement our standard examination response protocols and bring our full organizational capabilities to bear on addressing her team's requirements.",
        ...
        -5,
        "Push back on the characterization, noting that your dedicated staff have been working tirelessly around the clock and that the examination team's expectations may be unreasonable given the challenging circumstances, the limited preparation window, and the complex operational environment that makes rapid mobilization difficult without compromising other critical banking functions.",
    ...
    q("IT/Security", "The IT examiner requests your complete vulnerability scan results for the past 12 months, including all identified vulnerabilities and remediation status. You know that 23 critical vulnerabilities from 8 months ago were closed late (outside policy timeframes), and 4 critical vulnerabilities identified 6 weeks ago remain open. What do you provide?",
      buildChoices(
        "Provide the complete 12-month scan results with remediation status and compensating controls.",
        ...
        10,
        "Provide the comprehensive vulnerability scan results but strategically exclude the detailed remediation tracking reports that would specifically highlight the timeline violations on late closures, while still maintaining full transparency on current vulnerability status and offering to retrieve additional documentation if the examiner specifically requests those particular tracking metrics.",
        ...
        5,
        "Provide only the most recent 6 months of comprehensive vulnerability scanning results, explaining that historical data beyond this timeframe isn't readily accessible through our current systems architecture and would require significant effort to reconstruct from archived repositories, but offering to retrieve it if specifically needed for their detailed assessment.",
        ...
        -5,
        "Request detailed clarification on the specific scope and format requirements for the vulnerability data they're seeking, including whether they want raw scan outputs, processed reports, or executive summaries, to avoid providing more comprehensive information than necessary for their particular review objectives and ensure you're meeting their exact requirements efficiently.",
    ...
    q("IT/Security", "An examiner is interviewing your network administrator about access controls. Afterward, your admin tells you the examiner asked several questions about a shared administrator account that's used for emergency system access. The admin explained it honestly - the account exists and is used occasionally. You know this account wasn't documented in your policies and violates your access management standards. What do you do?",
      buildChoices(
        "Document the shared account details and provide to the examiner while beginning remediation planning.",
        ...
        10,
        "Provide comprehensive guidance to the administrator on how to respond to any potential follow-up questions, emphasizing the critical importance of explaining the robust compensating controls in place, the strictly limited and monitored use of the account, and the legitimate business justification for maintaining this emergency access capability within your operational framework.",
        ...
        5,
        "Take a careful wait-and-see approach to determine if the examiner raises the shared administrator account as a formal finding before proactively providing any additional detailed information about it, since premature disclosure might create unnecessary scrutiny of what could be considered a minor administrative variance.",
        ...
        -5,
        "Carefully explain to the examiner that the network administrator may have been confused about the specific technical terminology and that what was described as a 'shared account' is actually a properly documented emergency access process that fully complies with your established security protocols and industry best practices for system administration.",
    ...
    q("IT/Security", "The examiner asks to observe a live demonstration of your incident response procedures by having your team respond to a simulated phishing attack. Your IR procedures are documented but haven't been tested in 9 months - the last test revealed several gaps that were supposed to be addressed but weren't. What's your response?",
      buildChoices(
        "Agree to the demonstration while disclosing test history and known gaps.",
        ...
        10,
        "Request adequate time to properly prepare the incident response team for the demonstration, explaining that you want to ensure the most accurate and comprehensive representation of your organization's cybersecurity capabilities and that a rushed demonstration might not reflect the true effectiveness of your security protocols when properly executed by fully prepared personnel.",
        ...
        5,
        "Explain that incident response procedures contain sensitive security methodologies and that conducting a live demonstration could potentially compromise critical security controls and protective measures, offering instead to provide a detailed walkthrough of the comprehensive documentation and response frameworks that govern your cybersecurity incident management processes.",
        ...
        -5,
        "Proceed confidently with the live incident response demonstration, trusting that your experienced team will perform effectively and that any operational improvements implemented since the last formal testing cycle will result in a more successful execution that appropriately demonstrates your organization's enhanced cybersecurity readiness and incident management capabilities.",
    ...
    q("HR", "An examiner wants to interview the employee who handles BSA suspicious activity report (SAR) filings. This employee has been covering BSA duties since the BSA Officer resigned but hasn't been formally designated, trained, or given authority. They're nervous about the interview and worried about saying the wrong thing. How do you prepare them?",
      buildChoices(
        "Be honest about their position, reassure job security, and brief them on actual versus expected responsibilities.",
        ...
        10,
        "Provide the employee with comprehensive documentation about Bank Secrecy Act requirements, anti-money laundering regulations, and suspicious activity reporting protocols, and coach them thoroughly on the key compliance concepts and regulatory expectations so they can answer the examiner's questions with greater confidence and demonstrate adequate knowledge of their responsibilities.",
        ...
        5,
        "Arrange for a senior BSA compliance manager or other experienced supervisor to sit in on the interview to provide support and help answer any complex questions that the employee might not be able to handle independently, ensuring comprehensive and accurate responses to the examiner's inquiries.",
        ...
        -5,
        "Request that the examiner interview the acting BSA Officer or another appropriately designated compliance professional instead, since they would be the more appropriate person to answer detailed BSA and suspicious activity reporting questions given their formal authority and comprehensive knowledge of the bank's anti-money laundering programs.",
    ...
    q("Finance", "The liquidity examiner asks about your contingency funding plan. Upon review, you realize the plan hasn't been updated in 14 months and still references credit facilities that have been modified, assumptions that are outdated, and contact information for people who've left the bank. What do you do?",
      buildChoices(
        "Acknowledge it needs refresh, provide a verbal summary, and commit to updates within 30 days.",
        ...
        10,
        "Quickly update the most obvious errors including outdated contact information, modified facility details, and key assumption changes, and provide the corrected version to the examiner, explaining that you identified some administrative updates that were needed during your review and wanted to ensure they had the most current information available.",
        ...
        5,
        "Explain that while some reference details may need updating, the core contingency funding plan is fundamentally sound and that the outdated contact information and facility modifications are minor administrative issues that don't affect the overall viability and effectiveness of the strategic contingency approach.",
        ...
        -5,
        "Note that the bank's liquidity position has been consistently strong throughout the recent period so the contingency funding plan hasn't needed to be activated or relied upon, which is why regular updates weren't prioritized over other critical operational activities and regulatory requirements that demanded immediate attention.",
    ...
    q("Finance", "On the last day, the Examiner-in-Charge mentions that the exam will include a Matter Requiring Attention (MRA) related to liquidity risk management practices, specifically the contingency funding plan. She asks if you'd like to discuss the proposed language before the report is finalized. What's your approach?",
      buildChoices(
        "Accept the opportunity to discuss. Focus on accuracy and realistic timelines.",
        ...
        10,
        "Accept the discussion and try to negotiate the supervisory finding down to a Recommendation rather than a formal Matter Requiring Attention, given that no actual liquidity stress occurred and the bank's liquidity position has remained strong throughout the review period, suggesting that any planning documentation deficiencies haven't created material risk.",
        ...
        5,
        "Decline the opportunity for discussion, noting that you prefer to receive the formal written finding and will respond through the established official channels rather than engaging in informal negotiations that could compromise the integrity of the examination process.",
        ...
        -5,
        "Accept the discussion opportunity but push back strongly on the MRA determination, arguing that your institution's liquidity position has been consistently strong and well-managed, and that a contingency funding plan documentation issue doesn't warrant formal supervisory action when there's no evidence of material deficiencies in actual liquidity risk management practices.",
    ...
    q("Loans", "The credit examiner is reviewing your largest criticized assets and asks for the credit file on a $3.2 million commercial real estate loan that was downgraded to Substandard 4 months ago. You know this file has documentation gaps - the most recent appraisal is 2 years old, financial statements are 18 months stale, and the workout notes are incomplete. What do you do?",
      buildChoices(
        "Provide the file as-is, acknowledge gaps, and describe remediation actions.",
        ...
        10,
        "Provide the comprehensive credit file but prepare a detailed supplemental memo explaining the documentation gaps and providing your current understanding of the borrower's financial status, collateral position, and workout progress to ensure the examiner has complete context for their review.",
        ...
        5,
        "Request a day to prepare the file for examiner review, using the time to update documentation where possible and ensuring that all materials are properly organized and current before presentation.",
        ...
        -5,
        "Explain that this particular credit is currently in an active workout status and that documentation practices and requirements differ during the workout phase compared to performing loans, which accounts for any gaps in standard credit administration procedures.",
    ...
    q("Loans", "The examiner identifies 3 loans totaling $1.8 million that they believe should be downgraded from Pass to Special Mention based on borrower financial deterioration. Your loan officers disagree - they've met with these borrowers and believe the situations are improving. The examiner's analysis is based solely on financial statement ratios. How do you handle the disagreement?",
      buildChoices(
        "Prepare a written response for each loan with qualitative factors and request a professional meeting.",
        ...
        10,
        "Accept the examiner's credit classifications to avoid conflict and potential relationship damage, planning to re-evaluate the loans after the examination concludes and implement any necessary adjustments once the immediate regulatory review pressure has passed.",
        ...
        5,
        "Escalate the classification disagreement to the Examiner-in-Charge immediately, arguing that the credit examiner is inappropriately substituting their judgment for bank management's lending decisions without adequate basis or understanding of the borrower relationships and market conditions.",
        ...
        -5,
        "Point out that the examiner hasn't personally met with the borrowers and therefore lacks the important relationship context and qualitative understanding that informs your classification decisions, which should carry significant weight in the evaluation.",
    ...
    q("Loans", "Near the end of the exam, you learn that the credit examiner intends to classify a $4.7 million relationship as Loss (requiring immediate charge-off) that you have classified as Doubtful. The difference is approximately $2.1 million in additional charge-off that would materially impact quarterly earnings. The examiner's position is that the collateral liquidation value doesn't support the current carrying amount. What's your approach?",
      buildChoices(
        "Request a meeting with the examiner and CCO to understand their valuation and provide documentation.",
        ...
        10,
        "Immediately engage an independent appraisal firm to provide an updated collateral valuation that you can submit before the report is finalized, ensuring that you have the most current and defensible market-based assessment available for this significant credit decision.",
        ...
        5,
        "Escalate the classification disagreement to the Examiner-in-Charge, arguing that a classification requiring $2.1 million in charge-offs should receive more senior examiner review and oversight before being finalized given the materiality.",
        ...
        -5,
        "Accept the Loss classification for now and file a formal appeal after the examination, when you'll have more time to prepare comprehensive supporting documentation and develop a stronger case without the pressure of exam timeline constraints.",
...
const SCENARIO_VENDOR_OUTAGE = {
  ...
  questions: [
    ...
    q("CEO/SVPs", "It's now 6:00 AM and you have no reliable information from the vendor about cause or restoration timeline. Your board chair is calling, customers are flooding social media, and branch managers are asking what to tell staff arriving for the 8:00 AM opening. What's your immediate leadership approach?",
      buildChoices(
        "Activate incident command with clear roles: vendor contact, customer communications, and branch guidance. Brief the board chair with known facts.",
        ...
        10,
        "Concentrate all available management resources on continuously attempting vendor contact through every possible channel, including executives, account managers, emergency hotlines, and social media, since any customer communications or operational decisions without knowing the restoration timeline could prove inaccurate and damage credibility when facts emerge.",
        ...
        5,
        "Immediately issue a comprehensive public statement clearly blaming the vendor for the outage and explaining that this operational disruption is completely outside your control, detailing their failure to provide adequate infrastructure and emphasizing to customers that accountability lies with the vendor's poor system architecture.",
        ...
        -5,
        "Delay the scheduled 8:00 AM branch opening until you have clear restoration estimates and comprehensive information from the vendor to avoid having staff face customers without concrete answers about service availability and restoration timelines.",
    ...
    q("CEO/SVPs", "By noon, the vendor has provided three different restoration estimates, each pushed back within hours of being given. Customer complaints are now trending on social media, and a regional newspaper is preparing a story about 'local banks leaving customers stranded.' The vendor's CEO has offered to do a joint statement with affected banks. What's your approach?",
      buildChoices(
        "Issue your own communication focused on what customers can do: branch services, ATM access, and alternative payment methods.",
        ...
        10,
        "Participate in the comprehensive joint statement to present a unified industry response and share the reputational burden across the 127 affected institutions while emphasizing collective resilience and coordinated customer service efforts throughout the extended outage period.",
        ...
        5,
        "Wait for the vendor to successfully resolve the technical issue before making any public statements or commitments, since any customer communication now could prove wrong given the repeatedly unreliable timeline estimates and changing technical assessments.",
        ...
        -5,
        "Use social media platforms to publicly pressure the vendor by tagging their executives and demanding accountability for the system failure, showing customers that you're fighting aggressively for them and holding the vendor responsible for the service disruption.",
    ...
    q("Accounting", "It's day two and you've been processing transactions through manual workarounds: paper tickets, spreadsheets, and email authorizations. You estimate 3,400 transactions worth $8.7 million have been processed outside normal systems. Some entries have incomplete information. Systems may restore later today. How do you prepare for reconciliation?",
      buildChoices(
        "Halt new manual processing and assign a team to organize and digitize records now before systems restore.",
        ...
        10,
        "Continue manual processing for immediate customer-facing needs but stand up a dedicated reconciliation triage team now to digitize records, prioritize items by risk and value, and prepare comprehensive templates so post-restoration reconciliation is tractable and manageable.",
        ...
        5,
        "Stop taking any new transactions until systems restore to prevent the reconciliation problem from growing larger and more complex to manage.",
        ...
        -5,
        "Wait for systems to restore and rely entirely on the vendor's automated reconciliation tools to identify and resolve discrepancies automatically without manual intervention.",
    ...
    q("Accounting", "Systems are restored but the reconciliation reveals a $47,000 discrepancy between your manual records and the restored core system. Despite significant effort, you can't identify the source. The month-end close is in 3 days. Your external auditors are asking about the outage's impact on financial statement reliability. How do you proceed?",
      buildChoices(
        "Record in suspense account after prioritized reconciliation of highest-risk items. Document steps and disclose to auditors.",
        ...
        10,
        "If the accelerated forensic work can't reasonably resolve the variance within available time, request a narrowly scoped extension for the close limited to completing the reconciliation of this item and provide auditors with comprehensive interim documentation of efforts and methodologies.",
        ...
        5,
        "Book the discrepancy as an incident-related expense and move on, since the amount is immaterial relative to the institution's size and extended investigation isn't worth the cost.",
        ...
        -5,
        "Split the discrepancy across multiple accounts to keep any single variance below internal investigation thresholds and avoid highlighting the reconciliation failure to auditors.",
    ...
    q("Deposits", "Branch lobbies are filling with customers who can't use ATMs, can't use debit cards, and can't access online banking. Your tellers can do basic transactions using paper records and signature cards but can't verify balances or transaction history. Some customers are demanding to withdraw their entire balances but you can't confirm what those balances are. How do you handle large withdrawal requests?",
      buildChoices(
        "Establish a reasonable maximum for unverified withdrawals (perhaps $500-1,000) with proper ID. Document all transactions meticulously.",
        ...
        10,
        "Honor any withdrawal request where the customer can provide a recent statement showing sufficient balance, using the customer's statement as verification documentation for the transaction.",
        ...
        5,
        "Refuse all withdrawal requests until systems restore since you can't properly verify customer authority to access accounts without system validation and balance confirmation.",
        ...
        -5,
        "Trust long-standing customers for larger withdrawals based on teller recognition and relationship history, while being more cautious and restrictive with less familiar customers and recent account holders.",
    ...
    q("Deposits", "A business customer calls saying they're a restaurant and need to make their daily deposit of $12,000 in cash - they have no secure place to hold it overnight and their insurance doesn't cover cash on premises. Your vault systems are down so you can't process deposits normally. They're a 15-year customer. What do you offer?",
      buildChoices(
        "Accept the deposit using a manual receipt and secured storage. Process first thing when systems restore.",
        ...
        10,
        "Accept the deposit but explain it won't post to their account until systems restore, which could be several days, and they won't earn interest during that delay period.",
        ...
        -5,
        "Accept the deposit but require them to sign a comprehensive hold-harmless agreement waiving any claims if the funds are lost or misposted during the manual process.",
    ...
    q("Deposits", "After systems restore, you discover that 23 customers were incorrectly charged overdraft fees during the outage due to timing issues with pending transactions. Total fees are $1,840. Your operations manager suggests reversing the fees proactively before customers complain. Your compliance officer is concerned that some of those overdrafts were legitimately incurred regardless of the outage. What do you do?",
      buildChoices(
        "Reverse all 23 fees proactively. The outage created timing issues customers couldn't account for.",
        ...
        10,
        "Review each individual overdraft transaction carefully to determine whether it was caused by outage timing or would have occurred anyway, reversing only those clearly outage-related while maintaining fees for legitimately incurred overdrafts.",
        ...
        5,
        "Wait for customers to complain about the fees and reverse them for those who contact you, since many customers may not notice the small charges.",
        ...
        -5,
        "Retain all the fees since overdraft disclosures make clear that fees apply regardless of circumstances, and the outage doesn't change the contractual terms.",
...
const SCENARIO_INSIDER_FRAUD = {
  ...
  questions: [
    ...
    q("CEO/SVPs", "It's Monday morning and internal audit just briefed you on the findings. The suspected employee is currently at their desk. Their brother-in-law (the manager) is in a meeting. Your General Counsel is traveling. The audit committee chair has a standing request to be notified of any fraud findings. What's your immediate sequence of actions?",
      buildChoices(
        "Have security escort the employee to HR while IT disables access. Call General Counsel and brief audit committee chair.",
        ...
        10,
        "Wait for General Counsel to return tomorrow before taking any action, continuing normal monitoring of the employee's activity to gather additional evidence and develop a more comprehensive understanding of the potential scheme.",
        ...
        5,
        "Immediately confront both the suspected employee and their manager-brother-in-law together to get their explanations before deciding on next steps.",
        ...
        -5,
        "Convene the full executive team to discuss the findings comprehensively and build consensus on an approach before taking any action that might expose the bank to litigation.",
    ...
    q("CEO/SVPs", "After the employee is placed on administrative leave, their spouse (who doesn't work at the bank) calls the CEO's office threatening to 'go to the media' if their partner isn't immediately reinstated, claiming this is retaliation for a discrimination complaint filed last month. You weren't aware of any discrimination complaint. What approach do you take?",
      buildChoices(
        "Direct the call to HR, verify if a discrimination complaint exists, and continue the fraud investigation on its merits.",
        ...
        10,
        "Explain to the spouse that their partner was placed on administrative leave due to a serious matter unrelated to any discrimination complaint, and that the bank follows fair processes for all employees.",
        ...
        -5,
        "Engage your media relations team to prepare a comprehensive response in case the spouse follows through on their threat, getting ahead of the story.",
    ...
    q("CEO/SVPs", "External auditors are scheduled to begin fieldwork in 3 weeks. Your CFO suggests delaying notification until you've completed your internal investigation so you can present a complete picture. Your General Counsel suggests immediate disclosure because the auditors will likely discover it anyway. The identified losses are below your audit materiality threshold. What's your approach?",
      buildChoices(
        "Notify the external auditors promptly, demonstrating governance integrity and preventing appearance of concealment.",
        ...
        5,
        "Don't proactively notify since the amounts are below materiality; if auditors discover the matter during fieldwork, provide full cooperation.",
