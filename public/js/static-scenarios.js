  ...
  questions: [
    ...
    q("IT/Security", "Forensics reports that your backup infrastructure appears clean, but they've found evidence the attackers had access to your environment for 3 weeks before deploying ransomware. Your most recent clean backup is 18 hours old but any backup from the past 3 weeks could contain dormant malware or compromised credentials. What's your restoration strategy?",
      buildChoices(
        ...
        0,
        "Rebuild all systems from scratch to eliminate any possibility of dormant compromise, even if it extends recovery into weeks.",
    ...
    q("IT/Security", "Online banking restoration is technically ready but your security team hasn't completed penetration testing on the restored environment. Customer complaints are mounting - 47,000 customers have called the contact center today. Business leaders are pushing hard to restore service. What's your recommendation?",
      buildChoices(
        ...
        0,
        "Open limited transactional functionality only for prioritized customers (e.g., high-value or critical accounts) after bespoke verification, delaying broader restoration.",
    ...
    q("HR", "It's Day 2 and your IT security team has been working 20+ hour shifts. The CISO reports that two senior engineers are showing signs of severe fatigue - making configuration errors and forgetting steps in procedures. However, these engineers have critical institutional knowledge about the encrypted systems. Pulling them off could slow recovery significantly. What do you recommend?",
      buildChoices(
        ...
        2,
        "Immediately replace the fatigued engineers with external contractors to keep recovery speed high, accepting onboarding and knowledge-transfer risk.",
    ...
    q("HR", "Branch managers report that several employees are posting on social media about the outage, including one who wrote 'Management has no idea how bad this is - our systems are totally destroyed.' The posts are gaining attention. How should this be handled?",
      buildChoices(
        ...
        1,
        "Do nothing publicly and focus on private operational recovery; let the issue fade as the situation improves.",
    ...
    q("HR", "Several employees have approached HR confidentially expressing fear that they'll be blamed or terminated for the security breach, even though there's no indication of employee fault. One employee who clicked a phishing link (not confirmed as the entry point) is particularly distressed. How do you address this?",
      buildChoices(
        ...
        0,
        "Announce that no one will face discipline for honest mistakes during the incident to ensure full cooperation with recovery and investigation.",
    ...
    q("Finance", "It's Day 3 and customers are increasingly withdrawing funds from your operational branches and ATMs - daily outflows have tripled versus normal. Media speculation about the bank's viability is growing. Your liquidity coverage ratio is still well above regulatory minimums but trending down. What's your recommendation?",
      buildChoices(
        "Subject to Treasury confirmation of immediate need and available delegated authority, consider activating contingency funding arrangements to pre-position additional liquidity while documenting expected cost, counterparty covenants, and communications implications. If activated, limit draws to narrowly defined, pre-agreed trigger levels and require dual sign-off (Treasury chair + CFO). When briefing stakeholders, acknowledge trade-offs (cost, signaling) and the residual uncertainty about market reaction, and commit to rapid reporting to the crisis lead.",
    ...
    q("Finance", "The $47 million in ACH transactions that were queued when systems went down include payroll files for 340 businesses representing 12,000 employees expecting direct deposits tomorrow. The ACH system won't be restored in time. What approach do you recommend?",
      buildChoices(
        "Prioritize targeted outreach to the largest employers and those with imminent payroll deadlines to explain options, timelines, and eligibility for emergency accommodations. Offer cashier's checks or expedited wires for critical payrolls where verification is possible, deploy a concise employer request form for expedited handling with minimal required verification fields, and log all accommodations for reconciliation and audit. Run parallel engagement with Fed/NACHA and correspondent banks to explore emergency routing where feasible, and assign a named liaison with SLAs for employer responses and reconciliation.",
        "Targeted outreach with a streamlined employer request form, named liaison and SLAs, and minimal verification prevents inconsistent promises; documenting accommodations preserves auditability while Fed/NACHA coordination may enable limited routing alternatives. Assign a named owner with SLAs for reconciliation and employer follow-up.",
        10,
        "Coordinate immediately with Fed/NACHA and your correspondent banks to identify emergency routing or exception options; pre-clear a prioritized subset of payroll files using pre-validated employer lists and threshold rules, require a one-page expedited request, assign a named liaison with SLAs for responses, and implement dual-approval for any manual wire equivalents. Ensure any pre-cleared files are reconciled with documented approvals post-incident.",
        "Pre-clearance with pre-validated rules, a named liaison, SLAs, and dual-approval for manual routing makes expedited processing operationally achievable while preserving strong audit trails. Assign a reconciliation owner and SLA for post-event audit.",
        5,
    ...
    q("Loans", "A large commercial borrower (a regional hospital with $45 million outstanding) calls demanding to draw their entire $15 million line of credit immediately, citing concerns about the bank's stability and their need to ensure operational funds. Their line is committed and they have a contractual right to draw. However, processing a $15 million manual disbursement carries significant operational and fraud risk. What do you recommend?",
      buildChoices(
        "Honor the draw request as a contractual commitment but implement strict, documented safeguards to mitigate operational and fraud risk: require a senior officer call-back to a pre-validated hospital treasury contact, dual approvals, treasury settlement coordination and confirmation of settlement mechanics, expedited fraud screening, and an auditable settlement confirmation with a named relationship lead to manage hospital concerns. Require real-time confirmation of settlement and record the steps for post-incident audit.",
    ...
    q("Accounting", "Your external auditors call asking about the incident's impact on your in-progress quarterly financial statement audit. They express concern about internal control reliance and ask whether the incident constitutes a material weakness. How do you respond?",
      buildChoices(
        "Schedule a meeting to walk through: the incident timeline, which controls remained effective, compensating controls implemented, transaction volumes and dollar amounts processed manually, your reconciliation and validation plan, named remediation owners with deadlines, and evidence you'll provide (sample reconciliations, exception logs). Be transparent about unknowns and the timeline for additional evidence; propose weekly checkpoints, an evidence-delivery timetable, and a named auditor liaison for follow-up.",
    ...
    q("Deposits", "Branch lobbies are packed with anxious customers demanding to withdraw funds and close accounts. Wait times exceed 2 hours. Some customers are verbally abusing tellers, and two tellers have been reduced to tears. News cameras have arrived and are filming the lines. What immediate actions do you take?",
      buildChoices(
        "Deploy additional staff including back-office personnel trained on basic transactions to reduce wait times, implement a rotating manager presence to triage and de-escalate, and authorize brief teller breaks to prevent burnout. Issue a focused media holding statement coordinated centrally to avoid inconsistent messaging; treat temporary withdrawal limits as a documented last-resort with clear escalation, oversight and post-action review.",
        "Staff augmentation and manager triage reduce immediate queue pressure while teller breaks protect wellbeing; central coordination of media messaging and documented escalation and review for limits reduces inconsistent local decisions. Assign a branch operations owner with SLAs for queue recovery.",
        10,
        "Stand up a 'fast lane' for basic withdrawals and simple transactions, route complex issues to a staffed help desk, assign senior managers to triage and approve documented emergency accommodations (with clear eligibility), publish teller FAQs and escalation criteria to ensure consistent treatment and auditability, and proactively communicate brief queuing guidance via lobby signage and social posts to reduce confusion. Publish the eligibility criteria and escalation contact for frontline staff.",
        "Fast lanes plus proactive signage and social guidance improve throughput and reduce escalation; published eligibility and manager approval prevent ad-hoc exceptions and ensure fair, auditable treatment. Assign a frontline ops owner with SLAs to manage the fast lane.",
        5,
  ...
  questions: [
    ...
    q("Accounting", "The failed and corrected files will create reconciliation complexity�some transactions will appear twice, some once, some with different effective dates. The suspense account is already growing. What approach is most appropriate?",
      buildChoices(
        ...
        10,
        "Use normal reconciliation procedures selectively: apply standard matching for routine items but escalate suspected duplicates and exceptions to the incident workspace with accelerated review. Preserve exception logs so auditors can see the distinction between routine and incident-driven treatments.",
    ...
    q("Accounting", "External auditors are currently on-site for quarterly procedures. They've heard about the incident and are asking for documentation. The incident is still being resolved. What approach is most appropriate?",
      buildChoices(
        ...
        10,
        "Offer auditors a staged documentation delivery: provide current incident materials now and commit to scheduled supplemental deliveries as investigations produce more detail. Proactively request specific auditor needs to prioritize what to assemble first.",
